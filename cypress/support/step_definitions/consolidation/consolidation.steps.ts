...
/**
 * @step Supports the Cucumber step: I continue to the consolidation account search as an {string}
 * defendant
 */
When(
...
/**
 * @step Supports the Cucumber step: I continue to the consolidation account search as an {string}
 * defendant selecting business unit {string}
 */
When(
...
/**
 * @step Supports the Cucumber step: I click Search on consolidation account search
 */
...
/**
 * @step Supports the Cucumber step: I clear the consolidation search
 */
...
/**
 * @step Supports the Cucumber step: I am on the consolidation Search tab for Individuals
 */
...
/**
 * @step Supports the Cucumber step: I am on the consolidation business unit and defendant type selection
 * screen
 */
...
/**
 * @step Supports the Cucumber step: I am on the consolidation Search tab for Companies
 */
...
/**
 * @step Supports the Cucumber step: the consolidation page header back link is displayed
 */
...
/**
 * @step Supports the Cucumber step: I click the consolidation page header back link
 */
...
/**
 * @step Supports the Cucumber step: I am on the consolidation Results tab
 */
...
/**
 * @step Supports the Cucumber step: I am on the consolidation Results tab for Individuals
 */
...
/**
 * @step Supports the Cucumber step: I am on the consolidation Results tab for Companies
 */
...
/**
 * @step Supports the Cucumber step: the created consolidation result account number is displayed as a
 * hyperlink
 */
...
/**
 * @step Supports the Cucumber step: I see the consolidation no matching results state
 */
...
/**
 * @step Supports the Cucumber step: the consolidation results exclude accounts with a balance of
 * {string}
 */
...
/**
 * @step Supports the Cucumber step: I click Check your search on consolidation no matching results
 */
...
/**
 * @step Supports the Cucumber step: I open the created consolidation result account in a new tab
 */
...
/**
 * @step Supports the Cucumber step: I see the consolidation search error page for {string}
 */
...
/**
 * @step Supports the Cucumber step: I go back from the consolidation search error page
 */
...
/**
 * @step Supports the Cucumber step: I enter the following consolidation search details:
 */
...
/**
 * @step Supports the Cucumber step: I switch consolidation tabs and return to Search
 */
...
/**
 * @step Supports the Cucumber step: the consolidation search details are retained:
 */

 ...
 */
When(
  'I trigger the route guard for a {string} defendant named {string}',
  (defendantType: string, defendantName: string) => {
 ...
 */
When(
  'I test cancel changes for a {string} defendant named {string}',
  (defendantType: string, defendantName: string) => {

Feature: PO-389 Test scenarios for court details screen - creating a fines account for an adult or youth
        ...
        Scenario Outline: AC1,AC2,AC3,AC4,AC8,AC9-positive: user enters data into all the fields
                ...
                When I enter "<prosecutorCaseRef>" into the "Prosecutor Case Reference (PCR)" field
                ...
                Examples:
                        ...
                        | 1428     | AC123NMJTGB345213LKJIUYT765MIO | 820              | Add personal details      | Personal details |

# Scenario Outline: AC5-negative: user does not enter data into any of the fields
#         When I enter "" into the "Sending area or Local Justice Area (LJA)" search box
#         When I enter "" into the "Prosecutor Case Reference (PCR)" field
#         When I enter "" into the "Enforcement court" search box
...
#         Examples:
#                 | returnButton             |
#                 | Retun to account details |
#                 | Add personal details     |

# Scenario Outline: AC6-negative: user does not enter data into any of the fields
...
#         Examples:
#                 | returnButton             | pcr                   |
#                 | Retun to account details | Alpha_1234@rate-09877 |
#                 | Add personal details     | Alpha_1234@rate-09877 |
...
#         Examples:
#                 | returnButton             | pcr                                   |
#                 | Retun to account details | Testing prosecutor case reference pcr |
#                 | Add personal details     | Testing prosecutor case reference pcr |

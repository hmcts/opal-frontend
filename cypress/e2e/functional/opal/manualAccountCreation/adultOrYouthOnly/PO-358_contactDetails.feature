Feature: PO-358_Contact Details for adult or youth only
  ...
  Scenario Outline: :AC7-negative: When user enters telephone numbers in incorrect format then user will be on the Contact details page
    ...
    When I enter incorrect work telephone number "<incorrectWorkTelephone>"
    ...
    Examples:
      | incorrectMobileNumber | incorrectHomeTelephone | incorrectWorkTelephone               |
  ...
  Scenario Outline: AC8-negative: When user enters incorrect data into all fields and amends the data will be on account details page
    ...
    When I update work telephone number "<workTelephone>"
    ...
    Examples:
      | incorrectPrimaryEmail         | incorrectSecondaryEmail                  | incorrectMobileNumber | incorrectHomeTelephone | incorrectWorkTelephone               | primaryEmail     | secondaryEmail       | homeTelephone | mobileTelephone | workTelephone |

Feature: PO-371 Contact Details for company
  ...
  Scenario Outline: AC1,3,4,5,6 - contact details - 'Return to account details' Happy path
    ...
    And I see "<primaryEmail>" value on "Primary Email Address" field
    And I see "<secondaryEmail>" value on "Secondary Email Address" field
    And I see "<mobileTelephone>" value on "Mobile telephone number" field
    And I see "<homeTelephone>" value on "Home telephone number" field
    And I see "<workTelephone>" value on "Work telephone number" field
  ...
  Scenario Outline: AC1,3,4,5,6 - contact details - 'Add employer details' Happy path
    When I enter "<primaryEmail>" into the "Primary Email Address" field
    And I enter "<secondaryEmail>" into the "Secondary Email Address" field
    And I enter "<mobileTelephone>" into the "Mobile telephone number" field
    And I enter "<homeTelephone>" into the "Home telephone number" field
  ...
  Scenario: AC2 - contact details - 'Return to account details' Happy path - No data entered
    And I see "" value on "Primary Email Address" field
    And I see "" value on "Secondary Email Address" field
    And I see "" value on "Mobile telephone number" field
    And I see "" value on "Home telephone number" field
    And I see "" value on "Work telephone number" field
  ...
  Scenario: AC2 - contact details - 'Add employer details' Happy path - No data entered
    And I see "" value on "Primary Email Address" field
    And I see "" value on "Secondary Email Address" field
    And I see "" value on "Mobile telephone number" field
    And I see "" value on "Home telephone number" field

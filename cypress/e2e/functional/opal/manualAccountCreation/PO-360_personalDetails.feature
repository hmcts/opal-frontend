Feature: verifying the personal details screen for adult or youth only defendant type
    ...
    #     Then I verify the text boxes "First names","Last name" below the sub heading "Alias 1"
    ...
    #     Then I verify the text boxes "First names","Last name" below the sub heading "Alias 2"
    ...
    #     Then I select add another alias
    #     Then I verify "Alias 4" sub heading
    #     Then I verify the text boxes "First names","Last name" below the sub heading "Alias 3"
    #     # And I see "Remove" link below the "Last name" field

    #     Then I select add another alias
    #     Then I verify "Alias 5" sub heading
    #     Then I verify the text boxes "First names","Last name" below the sub heading "Alias 4"
    #     # And I see "Remove" link below the "Last name" field

    #     Then I select "Remove" button
    #     Then I cannot see "Alias 5" sub heading
    #     Then I verify the text boxes "First names","Last name" below the sub heading "Alias 5"
    # # And I verify the "Remove" button below the "Alias 5"
    ...
    #     Then I verify "<firstNames>" and "<lastName>" data should not be existed
    # Example:
    #         | firstNames            | lastName                       |

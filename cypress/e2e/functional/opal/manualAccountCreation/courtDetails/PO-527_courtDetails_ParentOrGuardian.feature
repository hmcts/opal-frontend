Feature: PO-527 Test scenarios for court details screen - creating a fines account for an adult or youth with P/G to pay
  ...
  Scenario Outline: AC1, AC2, AC3, AC4, AC8, AC9-positive: User enters data into all the fields, return to account details
  ...
  Scenario Outline: AC1, AC2, AC3, AC4, AC8, AC9-positive: User enters data into all the fields, add parent or guardian details
    When I enter "<lja>" into the "Sending area or Local Justice Area (LJA)" search box
    And I see "Search using the code or name of the area that sent the transfer" under the "Sending area or Local Justice Area (LJA)" search box
    ...
    And I see "<pageName>" on the page header
    ...
    Examples:
      | lja  | prosecutorCaseRef              | enforcemnetCourt | returnButton                   | pageName                   |
      | 1428 | AC123NMJTGB345213LKJIUYT765MIO | 820              | Add parent or guardian details | Parent or guardian details |
  ...
  Scenario Outline: AC7bi-negative: User has entered a Prosecutor Case Reference that does not adhere to validation
    ...
    Examples:
      ...
      | Add parent or guardian details | Alpha_1234@rate-09877 |
  ...
  Scenario Outline: AC7bii-negative: User has entered a Prosecutor Case Reference that does not adhere to validation
    ...
    Examples:
      ...
      | Add parent or guardian details | Testing prosecutor case reference pcr |

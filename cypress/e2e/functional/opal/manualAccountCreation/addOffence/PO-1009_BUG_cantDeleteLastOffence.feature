Feature: PO-1009 - Bug - Adding 3 offences and deleting them, last offence cannot be deleted.

  Scenario Outline: Adding 3 offences and then deleting all of them

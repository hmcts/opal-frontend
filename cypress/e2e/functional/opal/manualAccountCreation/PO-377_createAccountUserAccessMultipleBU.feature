...
#   #Then I see the search box below business unit the help text
...
#   Then I see the error message "Select where the account is to be created and Select defendant type" at the top of the page

...
export class CommonActions {
   ...
   */
  public assertHeaderContains(expected: string, timeoutMs: number = 20_000): void {
   ...
   * @param timeoutMs - Optional timeout override for the assertion.
   */
  public assertServiceHeaderContains(expected: string, timeoutMs: number = 20_000): void {

@PO-1450
Feature: Tests for Populate and Submit Screens Containing Capitalization With Company Details
    ...
    Scenario: Verify capitalization is applied to all relevant fields and displayed correctly on the "Check Account Details" page
        ...
        # Test Capitalization in Company name
        ...
        # Test Capitalization in Company Alias 1

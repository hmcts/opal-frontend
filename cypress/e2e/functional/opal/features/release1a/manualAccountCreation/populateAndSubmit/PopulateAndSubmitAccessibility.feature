...
Feature: Accessibility Tests for Populate and Submit Screens
  ...
  @R1A @JIRA-STORY:PO-2766 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5535
  Scenario: Dashboard is accessible after sign in
    Then I check the page for accessibility

  @R1A @JIRA-STORY:PO-2766 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5536
  ...
  @R1A @JIRA-STORY:PO-2766 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5537
  Scenario: Originator type page passes accessibility checks
    When I open Manual Account Creation
    Then I check the page for accessibility

  @R1A @JIRA-STORY:PO-2790 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5538
  ...
  @R1A @JIRA-STORY:PO-2766 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5539
  ...
  @R1A @JIRA-STORY:PO-2767 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5540
  ...
  @R1A @JIRA-STORY:PO-2767 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5541
  ...
  @R1A @JIRA-STORY:PO-2766 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5542

...
Feature: Global Api Interceptor
  ...
  Rule: Manual account creation entrypoint
    ...
    Scenario Outline: Global error banner appears for <errorCode> responses when starting manual account creation
      ...
      @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5265 @R1A
      Examples: 400 response
        | errorCode |
        | 400       |

      @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5266 @R1A
      Examples: 401 response
        | errorCode |
        | 401       |

      @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5267 @R1A
      Examples: 403 response
        | errorCode |
        | 403       |

      @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5268 @R1A
      Examples: 404 response
        | errorCode |
        | 404       |

      @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5269 @R1A
      Examples: 406 response
        | errorCode |
        | 406       |

      @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5270 @R1A
      Examples: 408 response
        | errorCode |
        | 408       |

      @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5271 @R1A
      Examples: 415 response
        | errorCode |
        | 415       |

      @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5272 @R1A
      Examples: 503 response
        | errorCode |
        | 503       |

      @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5273 @R1A
      Examples: 500 response
        | errorCode |
        | 500       |

    @JIRA-EPIC:PO-2141 @JIRA-STORY:PO-2219 @JIRA-TEST-KEY:PO-5602 @JIRA-NFR:PO-2542 @R1A
    ...
    @JIRA-EPIC:PO-2141 @JIRA-STORY:PO-2109 @JIRA-TEST-KEY:PO-5275 @JIRA-NFR:PO-2542 @R1A
    ...
    @JIRA-EPIC:PO-2141 @JIRA-STORY:PO-2108 @JIRA-TEST-KEY:PO-5276 @JIRA-NFR:PO-2542 @R1A
    ...
    @JIRA-EPIC:PO-2141 @JIRA-STORY:PO-2110 @JIRA-TEST-KEY:PO-5277 @JIRA-NFR:PO-2542 @R1A
    ...
    @JIRA-EPIC:PO-2141 @JIRA-STORY:PO-2111 @JIRA-TEST-KEY:PO-5278 @JIRA-NFR:PO-2542 @R1A

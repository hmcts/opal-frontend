...
Feature: Account Logout
  ...
  @JIRA-STORY:PO-8886 @JIRA-EPIC:PO-812 @R1A @JIRA-TEST-KEY:PO-10020
  Scenario: Sign out after navigating to create account
    And I open Create and Manage Draft Accounts
    And I sign out
    Then I should be redirected to the sign-in page

  @JIRA-STORY:PO-8886 @JIRA-EPIC:PO-812 @R1A @JIRA-TEST-KEY:PO-10021
  ...
  @JIRA-STORY:PO-8886 @JIRA-EPIC:PO-812 @R1A @JIRA-TEST-KEY:PO-10022

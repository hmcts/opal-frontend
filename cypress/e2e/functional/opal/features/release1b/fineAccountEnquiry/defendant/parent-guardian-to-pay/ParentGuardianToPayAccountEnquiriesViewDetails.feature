...
Feature: Parent Guardian To Pay Account Enquiries View Details
  As a caseworker
  ...
  Rule: Youth-only add parent or guardian baseline
    ...
    @R1BDrop1 @JIRA-STORY:PO-1877 @JIRA-EPIC:PO-1875 @JIRA-TEST-KEY:PO-9981
    ...
    @R1BDrop1 @JIRA-STORY:PO-1877 @JIRA-EPIC:PO-1875 @JIRA-TEST-KEY:PO-5531
  ...
  Rule: Youth-only account with parent or guardian details
    ...
    @R1BDrop1 @JIRA-STORY:PO-5749 @JIRA-EPIC:PO-2990 @JIRA-TEST-KEY:PO-9982
    ...
    @R1BDrop1 @JIRA-STORY:PO-5749 @JIRA-EPIC:PO-2990 @JIRA-TEST-KEY:PO-9983
    ...
    @R1BDrop1 @JIRA-STORY:PO-1878 @JIRA-EPIC:PO-1875 @JIRA-TEST-KEY:PO-6355
    ...
    @R1BDrop1 @JIRA-STORY:PO-1878 @JIRA-EPIC:PO-1875 @JIRA-TEST-KEY:PO-9984
  ...
  Rule: Youth-only amend parent or guardian baseline
    ...
    @R1BDrop1 @JIRA-STORY:PO-3915 @JIRA-EPIC:PO-1875 @JIRA-TEST-KEY:PO-6356
  ...
  Rule: Non-paying defendant account baseline
    ...
    @R1BDrop1 @JIRA-STORY:PO-2315 @JIRA-STORY:PO-1663 @JIRA-EPIC:PO-812 @JIRA-TEST-KEY:PO-5526
    ...
    @R1BDrop1 @JIRA-STORY:PO-2315 @JIRA-STORY:PO-1663 @JIRA-EPIC:PO-812 @JIRA-TEST-KEY:PO-5527
    ...
    @R1BDrop1 @JIRA-STORY:PO-5749 @JIRA-EPIC:PO-2990

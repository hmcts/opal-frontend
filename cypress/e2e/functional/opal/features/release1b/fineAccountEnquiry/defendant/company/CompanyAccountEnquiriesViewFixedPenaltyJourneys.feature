...
Feature: Company Account Enquiries View Fixed Penalty Journeys
  High-value end-to-end journeys for viewing Fixed Penalty account details.
  This scenario covers opening a vehicle Fixed Penalty company account,
  confirming the Fixed penalty tab is available, and verifying the
  vehicle-specific Fixed penalty details shown on that tab.

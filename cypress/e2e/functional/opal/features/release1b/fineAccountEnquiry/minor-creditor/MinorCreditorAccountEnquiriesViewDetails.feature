...
Feature: Minor Creditor Account Enquiries View Details
  As a caseworker
  ...
  Rule: Minor creditor amend creditor details baseline
    ...
    @R1BDrop2 @JIRA-STORY:PO-1984 @JIRA-EPIC:PO-1285 @JIRA-TEST-KEY:PO-7549
    ...
    @R1BDrop2 @JIRA-STORY:PO-1984 @JIRA-EPIC:PO-1285 @JIRA-TEST-KEY:PO-7550
  ...
  Rule: Minor creditor History and notes tab
    ...
    @R1BDrop2 @JIRA-STORY:PO-2640 @JIRA-EPIC:PO-2653 @JIRA-TEST-KEY:PO-10039
    ...
    @R1BDrop2 @JIRA-STORY:PO-2640 @JIRA-EPIC:PO-2653 @JIRA-TEST-KEY:PO-10040

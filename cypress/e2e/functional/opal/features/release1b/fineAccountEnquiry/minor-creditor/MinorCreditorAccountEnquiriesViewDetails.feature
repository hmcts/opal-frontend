...
Feature: Minor Creditor Account Enquiries View Details
  ...
  Rule: Minor creditor History and notes tab
    ...
    @R1B @JIRA-STORY:PO-2640 @JIRA-EPIC:PO-2653 @JIRA-STORY:PO-2657 @JIRA-EPIC:PO-2655 @JIRA-TEST-KEY:PO-10039
    ...
    @R1B @JIRA-STORY:PO-2640 @JIRA-EPIC:PO-2653 @JIRA-STORY:PO-2657 @JIRA-EPIC:PO-2655 @JIRA-TEST-KEY:PO-10040

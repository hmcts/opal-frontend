...
Feature: Minor Creditor Account Enquiries View Details
  ...
  Rule: Minor creditor amend creditor details baseline
    ...
    @R1BDrop2 @JIRA-STORY:PO-1984 @JIRA-STORY:PO-9700 @JIRA-EPIC:PO-1285 @JIRA-TEST-KEY:PO-7550
  ...
  Rule: Minor creditor History and notes tab
    ...
    @R1BDrop2 @JIRA-STORY:PO-2640 @JIRA-EPIC:PO-2653 @JIRA-STORY:PO-2657 @JIRA-EPIC:PO-2655 @JIRA-TEST-KEY:PO-10040

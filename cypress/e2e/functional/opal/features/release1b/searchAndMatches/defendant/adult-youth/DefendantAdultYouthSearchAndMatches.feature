...
Feature: Defendant Adult Youth Search And Matches
  ...
  @JIRA-EPIC:PO-704 @R1BDrop1 @JIRA-STORY:PO-705 @JIRA-TEST-KEY:PO-5418
  ...
  @JIRA-EPIC:PO-704 @R1BDrop1 @JIRA-STORY:PO-705 @JIRA-TEST-KEY:PO-5422
  ...
  @JIRA-EPIC:PO-704 @R1BDrop1 @JIRA-STORY:PO-705 @JIRA-TEST-KEY:PO-5425 @JIRA-NFR:PO-2549
  ...
  @JIRA-EPIC:PO-704 @R1BDrop1 @JIRA-STORY:PO-705 @JIRA-TEST-KEY:PO-5426
  ...
  Scenario Outline: Error when two sections contain data (Individuals) - <validation_case>
    ...
    And I see the validation message "Reference data and account information cannot be entered together when searching for an account. Search using either:"
    And I see the listed options "account number, reference or case number, National Insurance number, advanced search"
    @R1BDrop1 @JIRA-EPIC:PO-704 @JIRA-TEST-KEY:PO-5427
    ...
    @R1BDrop1 @JIRA-EPIC:PO-704 @JIRA-TEST-KEY:PO-5428
    Examples: Reference and last name
      | validation_case         | accountNumber | reference | lastName |
      | Reference and last name |               | REF-123   | Smith    |

  @JIRA-EPIC:PO-704 @R1BDrop1 @JIRA-STORY:PO-705 @JIRA-TEST-KEY:PO-5438
  ...
  @R1BDrop1 @JIRA-TEST-KEY:PO-5439
  ...
  @JIRA-EPIC:PO-704 @R1BDrop1 @JIRA-STORY:PO-717 @JIRA-TEST-KEY:PO-5450
  ...
  @JIRA-EPIC:PO-2630 @JIRA-STORY:PO-2953 @R1BDrop1 @JIRA-TEST-KEY:PO-10016
  ...
  @JIRA-STORY:PO-2953 @JIRA-EPIC:PO-2630 @R1BDrop1 @JIRA-TEST-KEY:PO-10017
  ...
  @JIRA-STORY:PO-2953 @JIRA-EPIC:PO-2630 @R1BDrop1 @JIRA-TEST-KEY:PO-10018
  ...
  @JIRA-EPIC:PO-704 @R1BDrop1 @JIRA-STORY:PO-717 @JIRA-TEST-KEY:PO-5451
  ...
  @JIRA-EPIC:PO-704 @R1BDrop1 @JIRA-STORY:PO-717 @JIRA-TEST-KEY:PO-5452

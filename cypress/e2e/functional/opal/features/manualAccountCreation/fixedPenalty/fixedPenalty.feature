Feature: Manual fixed penalty account creation - Create Draft Account
  ...
  @PO-1104-AC1,AC1a
  Scenario: AC1 & AC1a. Search the offence list link opens new tab displaying Search Offences screen as per design artefact - Adult or Youth defendant

    When I select the "Adult or youth only" radio button
    And I click the "Continue" button
    Then I see "Fixed Penalty details" on the page header
    And I see the "search the offence list" link
    ...
    And I see "Short title" text on the page
    And I see "Act and section" text on the page
    And I see "Include inactive offence codes" text on the page
    And I see the "Search" button

  @PO-1104-AC2-Adult
  Scenario: AC2. Search offences link functionality for Adult or Youth defendant
    When I select the "Adult or youth only" radio button
    And I click the "Continue" button
    Then I see "Fixed Penalty details" on the page header
    When I open the "search the offence list" link in the same tab
  ...
  @PO-1104-AC2-Company
  Scenario: AC2. Search offences link functionality for Company defendant
    When I select the "Company" radio button
    And I click the "Continue" button
    Then I see "Fixed Penalty details" on the page header
    And I see the "search the offence list" link
    ...
    And I click the "Search" button
    Then I see "Search results" on the page header
    And I see "HY35014" in the Search results table in the "Code" column
    When I click on the "Back" link
    Then I see "Search offences" on the page header

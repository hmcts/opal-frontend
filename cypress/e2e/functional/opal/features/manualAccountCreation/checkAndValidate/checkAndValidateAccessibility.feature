...
Feature: Accessibility Tests for Check and Validate Screens
  ...
  @JIRA-STORY:PO-2762 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5562
  Scenario: Create and Manage landing page passes accessibility checks
    Then I check the page for accessibility

  @JIRA-STORY:PO-605 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5563
  ...
  @JIRA-STORY:PO-640 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5567
  ...
  @JIRA-STORY:PO-640 @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5568

...
Feature: Check and Validate Draft Accounts - E2E Technical Scenarios
  ...
  Scenario Outline: Approve draft account for <scenario>
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-4994
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-4995
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-4996
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-4997
    Examples: Youth
      | scenario                 | draftType        | identifierField           | identifierValue        | listName                                  | header                                      | banner                                                               |
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-4998
    Examples: Company
      | scenario              | draftType      | identifierField                | identifierValue                    | listName                           | header                             | banner                                                         |
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-4999
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-5000
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-5001

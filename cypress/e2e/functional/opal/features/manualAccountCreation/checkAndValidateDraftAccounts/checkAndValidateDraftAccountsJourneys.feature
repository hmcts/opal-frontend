...
Feature: Check and Validate Draft Accounts - E2E Technical Scenarios
  ...
  @JIRA-STORY:PO-2243 @JIRA-EPIC:PO-2220 @JIRA-NFR:PO-2505
  Scenario Outline: Approve draft account for <scenario>
    ...
    @R1A @UAT-Technical @JIRA-NFR:PO-2506 @JIRA-TEST-KEY:PO-7436
    Examples: Adult
    ...
    @R1A @UAT-Technical @JIRA-NFR:PO-2506 @JIRA-TEST-KEY:PO-7437
    ...
    @R1A @UAT-Technical @JIRA-NFR:PO-2506 @JIRA-TEST-KEY:PO-7438
    ...
    @R1A @UAT-Technical @JIRA-NFR:PO-2506 @JIRA-TEST-KEY:PO-7439
    ...
    @R1A @UAT-Technical @JIRA-NFR:PO-2506 @JIRA-TEST-KEY:PO-7440
    ...
    @R1A @UAT-Technical @JIRA-NFR:PO-2506 @JIRA-TEST-KEY:PO-7441
    Examples: Youth
      | scenario                 | draftType        | identifierField           | identifierValue        | listName                                  | header                                      | banner                                                               |
    ...
    @R1A @UAT-Technical @JIRA-NFR:PO-2506 @JIRA-TEST-KEY:PO-7442
    Examples: Company
      | scenario              | draftType      | identifierField                | identifierValue                    | listName                           | header                             | banner                                                         |
    ...
    @R1A @UAT-Technical @JIRA-NFR:PO-2506 @JIRA-TEST-KEY:PO-7443
    ...
    @R1A @UAT-Technical @JIRA-NFR:PO-2506 @JIRA-TEST-KEY:PO-7444
    ...
    @R1A @UAT-Technical @JIRA-NFR:PO-2506 @JIRA-TEST-KEY:PO-7445

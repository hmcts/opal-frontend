...
Feature: Check and Validate Draft Accounts - E2E Technical Scenarios
  ...
  Scenario Outline: Approve draft account for <scenario>
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-3306
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-3307
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-3308
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-3309
    Examples: Youth
      | scenario                 | draftType        | identifierField           | identifierValue        | listName                                  | header                                      | banner                                                               |
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-3310
    Examples: Company
      | scenario              | draftType      | identifierField                | identifierValue                    | listName                           | header                             | banner                                                         |
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-3311
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-3312
    ...
    @R1A @UAT-Technical @JIRA-KEY:POT-3313

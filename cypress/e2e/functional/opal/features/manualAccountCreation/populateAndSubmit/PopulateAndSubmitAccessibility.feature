...
Feature: Accessibility Tests for Populate and Submit Screens
  ...
  @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5535
  Scenario: Dashboard is accessible after sign in
    Then I check the page for accessibility

  @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5536
 ...
 @JIRA-STORY:PO-2763 @JIRA-EPIC:PO-2750 @JIRA-TEST-KEY:PO-5537
  ...
  @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5539
  ...
  @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5540
  ...
  @JIRA-EPIC:PO-2472 @JIRA-TEST-KEY:PO-5541

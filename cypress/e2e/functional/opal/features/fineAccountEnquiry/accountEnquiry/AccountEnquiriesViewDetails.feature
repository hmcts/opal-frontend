...
Feature: Account Enquiries – View Account Details
  ...
  Rule: Adult or youth account baseline
    ...
    @JIRA-EPIC:PO-1970 @JIRA-STORY:PO-1942 @JIRA-STORY:PO-1943 @JIRA-KEY:POT-4694
    ...
    @JIRA-EPIC:PO-1970 @JIRA-STORY:PO-1943 @JIRA-KEY:POT-4695
  ...
  Rule: Company account baseline
    ...
    @JIRA-EPIC:PO-1970 @JIRA-STORY:PO-1956 @JIRA-KEY:POT-4696
    ...
    @JIRA-EPIC:PO-1970 @JIRA-STORY:PO-1956 @JIRA-KEY:POT-4697

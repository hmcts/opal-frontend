Feature: Account Enquiries – Add Account Note
  ...
  Rule: Adult or youth defendant baseline
    Background:
      ...
      When I search for the account by last name "GrahamAddNoteSurname" and open the latest result
      Then I should see the page header contains "Mr James GRAHAMADDNOTESURNAME"
    ...
    Scenario: Cancelling a populated account note discards the draft
      ...
      Then I should see the header containing text "Mr James GRAHAMADDNOTESURNAME"
  ...
  Rule: Company account baseline
    Background:
      ...
      Then I should see the account header contains "AccNote comp"

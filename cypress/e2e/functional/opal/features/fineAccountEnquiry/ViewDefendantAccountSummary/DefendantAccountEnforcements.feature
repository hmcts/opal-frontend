...
Feature: Defendant account enforcement - Collection order
  ...
  Rule: Adult or youth account
    ...
    @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5349
    ...
    @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5350
    ...
    @JIRA-EPIC:PO-2219 @JIRA-TEST-KEY:PO-5351
  ...
  Rule: Adult or youth account with parent or guardian
    ...
    @JIRA-EPIC:PO-1675 @JIRA-TEST-KEY:PO-5352
  ...
  Rule: Company account
    ...
    @JIRA-EPIC:PO-1675 @JIRA-TEST-KEY:PO-5355

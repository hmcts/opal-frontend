...
Feature: Filter by Business Unit
  ...
  @R1B @JIRA-STORY:PO-711 @JIRA-STORY:PO-2610 @AC1a @JIRA-EPIC:PO-704 @JIRA-TEST-KEY:PO-5412
  ...
  @JIRA-EPIC:PO-704 @R1B @JIRA-STORY:PO-711 @AC1b @JIRA-TEST-KEY:PO-5413
  ...
  @JIRA-EPIC:PO-704 @R1B @JIRA-STORY:PO-711 @AC7 @JIRA-TEST-KEY:PO-5414
  ...
  @JIRA-EPIC:PO-704 @R1B @JIRA-STORY:PO-711 @AC8 @JIRA-TEST-KEY:PO-5415
  ...
  @JIRA-EPIC:PO-704 @R1B @JIRA-STORY:PO-711 @AC9 @JIRA-TEST-KEY:PO-5416
  ...
  @JIRA-EPIC:PO-704 @R1B @JIRA-STORY:PO-711 @AC10 @JIRA-TEST-KEY:PO-5417

...
Feature: Fines primary navigation visibility through journeys
  ...
  @JIRA-EPIC:PO-2627 @JIRA-STORY:PO-3722 @JIRA-TEST-KEY:PO-5287 @R1CEnforcementOperationalReporting
  ...
  @JIRA-EPIC:PO-2627 @JIRA-STORY:PO-3722 @JIRA-TEST-KEY:PO-5288 @R1CEnforcementOperationalReporting
  ...
  @JIRA-EPIC:PO-2627 @JIRA-STORY:PO-3722 @JIRA-TEST-KEY:PO-5289 @R1CEnforcementOperationalReporting
  Scenario: Cancelling a Search-led account note journey shows the primary navigation again
    Given I clear all approved accounts
    And I create a "adultOrYouthOnly" draft account with the following details and set status "Publishing Pending" using user "opal-test-10@dev.platform.hmcts.net":
      | Account_status                              | Submitted                 |
      | account.defendant.forenames                 | Journey                   |

...
Feature: Reports Landing Page
  Background:
    Given I am logged in on the Fines Search landing page with email "opal-test@dev.platform.hmcts.net"

  @JIRA-STORY:PO-2613 @JIRA-STORY:PO-3758 @JIRA-EPIC:PO-2627 @JIRA-TEST-KEY:PO-5284 @R1CEnforcementOperationalReporting
  ...
  @JIRA-STORY:PO-3758 @JIRA-EPIC:PO-3685 @R1CEnforcementOperationalReporting

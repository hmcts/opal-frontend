Feature: Account Search and Matches
    ...
    Scenario: As a user I can view account details of an defendant account
        And I create a "adultOrYouthOnly" draft account with the following detail:
        ...
        When I update the last created draft account with the status "Publishing Pending"
        And I enter "TestSurname" into the "Last name" field
        And I click the "Search" button
        Then I click the published account link
        Then I see "Mr John TESTSURNAME" on the page header

    @967
    Scenario: As a user I can view account details of a company account
        And I create a "company" draft account with the following detail:
            | Account_status                      | Submitted        |
        ...
        And I click the "Search" button
        Then I click the published account link
        Then I see "TEST COMPANY" on the page header

...
export const ACCOUNT_ENQUIRY_ENFORCEMENT_STATUS_ELEMENTS = {
  ...
  enforcementOverviewList: '#enforcementOverviewDetails',
  ...
  collectionOrderStatusValue: '#enforcementOverviewDetailsCollection_order_statusValue',
  daysInDefault: '#enforcementOverviewDetailsDays_in_defaultKey',
  daysInDefaultValue: '#enforcementOverviewDetailsDays_in_defaultValue',
  ...
  enforcementActionValue: '#lastEnforcementActionDetailsEnforcement_actionValue',
  reason: '#lastEnforcementActionDetailsReasonKey',
  reasonValue: '#lastEnforcementActionDetailsReasonValue',
  lastEnfEnforcer: '#lastEnforcementActionDetailsEnforcerKey',
  lastEnfEnforcerValue: '#lastEnforcementActionDetailsEnforcerValue',
  warrantNumber: '#lastEnforcementActionDetailsWarrant_numberKey',
  warrantNumberValue: '#lastEnforcementActionDetailsWarrant_numberValue',
  dateAdded: '#lastEnforcementActionDetailsDate_addedKey',
  dateAddedValue: '#lastEnforcementActionDetailsDate_addedValue',
  hearingDateValue: '#lastEnforcementActionDetailsHearing_dateValue',
  courtValue: '#lastEnforcementActionDetailsCourtValue',
  lastEnforcementActionDaysInDefaultValue: '#lastEnforcementActionDetailsDays_in_defaultValue',
  ...
  lastEnforcementActionCard: '#last-enforcement-action',

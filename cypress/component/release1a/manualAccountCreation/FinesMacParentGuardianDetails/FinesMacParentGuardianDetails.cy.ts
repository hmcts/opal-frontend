...
describe('FinesMacParentGuardianDetailsComponent', () => {
  ...
  it(
    '(AC.1) should not permit unsupported characters in address line 1',
    { tags: [...buildTags('@JIRA-STORY:PO-364'), '@JIRA-EPIC:PO-344', '@JIRA-TEST-KEY:PO-5102'] },
    () => {
      setupComponent(null, 'pgToPay');
      finesMacState.parentGuardianDetails.formData.fm_parent_guardian_details_address_line_1 = 'addré1';
  ...
  it(
    '(AC.1) should not permit unsupported characters in address line 2',
    { tags: [...buildTags('@JIRA-STORY:PO-364'), '@JIRA-EPIC:PO-344', '@JIRA-TEST-KEY:PO-5104'] },
    () => {
      setupComponent(null, 'pgToPay');
      finesMacState.parentGuardianDetails.formData.fm_parent_guardian_details_address_line_2 = 'addré2';
  ...
  it(
    '(AC.1) should not permit unsupported characters in address line 3',
    { tags: [...buildTags('@JIRA-STORY:PO-436'), '@JIRA-EPIC:PO-344', '@JIRA-TEST-KEY:PO-5106'] },
    () => {
      setupComponent(null, 'pgToPay');
      finesMacState.parentGuardianDetails.formData.fm_parent_guardian_details_address_line_3 = 'addré3';
  ...
  it(
    ...
    () => {
      ...
      finesMacState.parentGuardianDetails.formData.fm_parent_guardian_details_address_line_1 = '120 streeté';

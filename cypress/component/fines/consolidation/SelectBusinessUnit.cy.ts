...
describe('FinesConSelectBuFormComponent', () => {
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2412', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4701', '@R1CWriteOff'] },
    () => {
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2412', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4702', '@R1CWriteOff'] },
    () => {
      interceptUserState(USER_STATE_MOCK_PERMISSION_BU77);
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2412', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4703', '@R1CWriteOff'] },
    () => {
      interceptUserState(USER_STATE_MOCK_PERMISSION_BU77);
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2412', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4704', '@R1CWriteOff'] },
    () => {
      interceptUserState(USER_STATE_MOCK_PERMISSION_BU77);
      finesConFormData.fcon_select_bu_business_unit_id = null;
      setupComponent();

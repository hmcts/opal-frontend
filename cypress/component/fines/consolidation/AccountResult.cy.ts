...
describe('FinesConConsolidateAccComponent - Account Results', () => {
  ...
  describe('Individual tests', () => {
    ...
    it(
      ...
      { tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4943'] },
      () => {
        setupComponent();
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5870'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5871'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5872'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5873'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2420', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5874'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2420', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5875'],
      },
      () => {
        defendantAccountResults = [];
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5876'],
      },
      () => {
        setupComponent();
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5877'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5878'],
      },
      () => {
  ...
  describe('Company tests', () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5879'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5880'],
      },
      () => {
        setupComponent({ defendantType: 'company' });
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5881'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5882'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5883'],
      },
      () => {
        defendantAccountResults = [
          buildCompanyResult({
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2420', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5884'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2420', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5885'],
      },
      () => {
        defendantAccountResults = [];
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5886'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5887'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5888'],
      },
      () => {
  ...
  describe('Results tab functionality tests', () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2416', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5889'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2416', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5890'],
      },
      () => {
        defendantAccountResults[0].checks = { errors: [], warnings: [] };
        defendantAccountResults.push(createMultipleErrorsAndWarningsResult(), createMultipleWarningsResult());
    ...
    it(
      ...
      {
        tags: ['@JIRA-EPIC:PO-2294', '@JIRA-STORY:PO-2416', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5891'],
      },
      () => {
        defendantAccountResults[0].checks = { errors: [], warnings: [] };

...
describe('FinesConConsolidateAccComponent - Account Results', () => {
  ...
  describe('Individual tests', () => {
    ...
    it('AC1, AC1a, AC1b. should render the individual account results tab with populated mock data', { tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4918'] }, () => {
        setupComponent();
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4575'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4576'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4577'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4578'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2420', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4579'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2420', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4580'],
      },
      () => {
        defendantAccountResults = [];
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4581'],
      },
      () => {
        setupComponent();
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4582'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4583'],
      },
      () => {
  ...
  describe('Company tests', () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4584'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4585'],
      },
      () => {
        setupComponent({ defendantType: 'company' });
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4586'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4587'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4588'],
      },
      () => {
        defendantAccountResults = [
          buildCompanyResult({
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2420', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4589'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2420', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4590'],
      },
      () => {
        defendantAccountResults = [];
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4591'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4592'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2421', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4593'],
      },
      () => {
  ...
  describe('Results tab functionality tests', () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2416', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4594'],
      },
      () => {
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2416', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4595'],
      },
      () => {
        defendantAccountResults[0].checks = { errors: [], warnings: [] };
        defendantAccountResults.push(createMultipleErrorsAndWarningsResult(), createMultipleWarningsResult());
    ...
    it(
      ...
      {
        tags: ['@JIRA-STORY:PO-2294', '@JIRA-STORY:PO-2416', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-4596'],
      },
      () => {
        defendantAccountResults[0].checks = { errors: [], warnings: [] };

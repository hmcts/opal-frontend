...
describe('FinesConConsolidateAccComponent - Account & Company Search', () => {
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5892', '@JIRA-EPIC:PO-2294'] },
    () => {
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5893', '@JIRA-EPIC:PO-2294'] },
    () => {
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5894', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5895', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5896', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5897', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5898', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5899', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5900', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5901', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5902', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5903', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5904', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5905', '@JIRA-EPIC:PO-2294'] },
    () => {
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5906', '@JIRA-EPIC:PO-2294'] },
    () => {
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5907', '@JIRA-EPIC:PO-2294'] },
    () => {
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5908', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5909', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData.fcon_search_account_number = '1234567';
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5910', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData.fcon_search_account_number = '123456789A';
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5911', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5912', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5913', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5914', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData.fcon_search_account_number = '12345678';
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5915', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5916', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-KEY:POT-5917', '@JIRA-EPIC:PO-2294'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),

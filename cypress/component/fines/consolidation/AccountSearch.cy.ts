...
describe('FinesConConsolidateAccComponent - Account & Company Search', () => {
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4673', '@R1CWriteOff'] },
    () => {
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4674', '@R1CWriteOff'] },
    () => {
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4675', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4676', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4677', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4678', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4679', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4680', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4681', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4682', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4683', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4684', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4685', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4686', '@R1CWriteOff'] },
    () => {
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4687', '@R1CWriteOff'] },
    () => {
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4688', '@R1CWriteOff'] },
    () => {
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4689', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4690', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData.fcon_search_account_number = '1234567';
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4691', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData.fcon_search_account_number = '123456789A';
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4692', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4693', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4694', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4695', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData.fcon_search_account_number = '12345678';
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2413', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4696', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4697', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),
  ...
  it(
    ...
    { tags: ['@JIRA-STORY:PO-2415', '@JIRA-LABEL:consolidation', '@JIRA-EPIC:PO-2294', '@JIRA-TEST-KEY:PO-4698', '@R1CWriteOff'] },
    () => {
      const updateSearchSpy = Cypress.sinon.spy();
      finesConSearchAccountFormData = {
        ...structuredClone(FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK.formData),

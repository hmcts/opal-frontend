...
export const INDIVIDUAL_SEARCH_STATE_MOCK: IFinesSaSearchAccountState = {
  ...
  fsa_search_account_individual_search_criteria: {
    fsa_search_account_individual_last_name: 'Smith',
    ...
    fsa_search_account_individual_date_of_birth: '1980-05-15',
    fsa_search_account_individual_national_insurance_number: 'AB123456C',
    fsa_search_account_individual_address_line_1: '123 Test Street',
    fsa_search_account_individual_post_code: 'SW1A 1AA',
  },

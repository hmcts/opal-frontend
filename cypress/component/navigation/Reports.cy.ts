...
describe('Reports dashboard navigation', { tags: [REPORTS_STORY_TAG, REPORTS_EPIC_TAG, REPORTS_JIRA_LABEL] }, () => {
  ...
  it('AC1a AC1b AC1d AC2a AC2b AC2c AC2d shows the Your reports panel and Operational reports links in the correct order', {tags: ['@JIRA-KEY:POT-4743']}, () => {
    commonSetup();
  ...
  it('AC1c routes View all your reports to the Your reports summary list screen', {tags: ['@JIRA-KEY:POT-4744']}, () => {
    commonSetup();
  ...
  it('AC3a routes Operational reports by enforcement to the correct summary list screen', {tags: ['@JIRA-KEY:POT-4745']}, () => {
    commonSetup();
  ...
  it('AC3b routes Operational reports by payments to the correct summary list screen', {tags: ['@JIRA-KEY:POT-4746']}, () => {
    commonSetup();
  ...
  it('AC1c renders the Your reports summary list heading', {tags: ['@JIRA-KEY:POT-4747']}, () => {
    yourReportsSummaryListSetup();

    cy.contains(L.pageHeader, 'Your reports').should('be.visible');
  });

  it('AC3a renders the Operational reports by enforcement summary list heading', {tags: ['@JIRA-KEY:POT-4748']}, () => {
  ...
  it('AC3b renders the Operational reports by payments summary list heading', {tags: ['@JIRA-KEY:POT-4749']}, () => {
    operationalReportsByPaymentsSummaryListSetup();

    cy.contains(L.pageHeader, 'Operational reports (by payments)').should('be.visible');
  });

  it('AC4d hides the Operational reports group when the user has no operational report permissions', {tags: ['@JIRA-KEY:POT-4750']}, () => {
  ...
  it('AC4a AC4c shows only the enforcement link and keeps the Operational reports heading visible', {tags: ['@JIRA-KEY:POT-4751']}, () => {
  ...
  it('AC4b AC4c shows only the payments link and keeps the Operational reports heading visible', {tags: ['@JIRA-KEY:POT-4752']}, () => {

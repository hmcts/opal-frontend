...
describe(
  ...
  () => {
    ...
    it('AC4e hides Reports from the primary navigation when the user has no report permissions in any business unit', {tags: ['@JIRA-KEY:POT-4741']}, () => {
    ...
    it('shows Reports in the primary navigation when the user has a report permission in any business unit', {tags: ['@JIRA-KEY:POT-4742']}, () => {

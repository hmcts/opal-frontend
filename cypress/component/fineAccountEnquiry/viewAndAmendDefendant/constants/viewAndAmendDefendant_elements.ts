...
export const ERROR_MESSAGES = {
  ...
  FORMAT_PHONE_EMPLOYER: 'Enter a valid employer telephone number in the correct format, like 07700 900 982 or 01263 766122',
  ...
  DATA_TYPE_VEHICLE_MAKE: 'Vehicle make and model must only include letters a to z, numbers, hyphens, spaces and apostrophes',
  DATA_TYPE_VEHICLE_REGISTRATION: 'Vehicle registration must only include letters a to z, numbers, hyphens, spaces and apostrophes',
  DATA_TYPE_EMPLOYER_NAME: 'Employer name must only include letters a to z, numbers, hyphens, spaces and apostrophes',
  DATA_TYPE_EMPLOYER_REFERENCE: 'Employer reference must only include letters a to z, numbers, hyphens, spaces and apostrophes',
  DATA_TYPE_EMPLOYER_ADDRESS_LINE_1: 'Employer address line 1 must only include letters a to z, numbers, hyphens, spaces and apostrophes',
  DATA_TYPE_EMPLOYER_ADDRESS_LINE_2: 'Employer address line 2 must only include letters a to z, numbers, hyphens, spaces and apostrophes',
  DATA_TYPE_EMPLOYER_ADDRESS_LINE_3: 'Employer address line 3 must only include letters a to z, numbers, hyphens, spaces and apostrophes',
  DATA_TYPE_EMPLOYER_ADDRESS_LINE_4: 'Employer address line 4 must only include letters a to z, numbers, hyphens, spaces and apostrophes',
  DATA_TYPE_EMPLOYER_ADDRESS_LINE_5: 'Employer address line 5 must only include letters a to z, numbers, hyphens, spaces and apostrophes',
  DATA_TYPE_EMPLOYER_POSTCODE: 'Employer postcode must only include letters a to z, numbers, hyphens, spaces and apostrophes',
  ...
  DATA_TYPE_COMPANY_NAME: 'Company name must only include letters a to z, numbers 0-9 and certain special characters (hyphens, spaces, apostrophes)',
  DATA_TYPE_COMPANY_ALIAS_1: 'Alias 1 company name must only include letters a to z, numbers 0-9 and certain special characters (hyphens, spaces, apostrophes)',
  DATA_TYPE_COMPANY_ALIAS_2: 'Alias 2 company name must only include letters a to z, numbers 0-9 and certain special characters (hyphens, spaces, apostrophes)',
};

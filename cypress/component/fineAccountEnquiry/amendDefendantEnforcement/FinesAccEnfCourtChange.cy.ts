...
describe('Change Enforcement Court - Individual', { tags: ADULT_OR_YOUTH_TAGS }, () => {
  it('should navigate to the change enforcement court screen and display the form', {tags: ['@JIRA-KEY:POT-4762', '@JIRA-KEY:POT-4764', '@JIRA-KEY:POT-4766']}, () => {
  ...
  it('should show validation errors when no enforcement court is selected', {tags: ['@JIRA-KEY:POT-4763', '@JIRA-KEY:POT-4765', '@JIRA-KEY:POT-4767']}, () => {
    // AC3a
    commonSetup();

export const DOM_ELEMENTS = {
  ...
  tableWrapper: 'app-fines-sa-results-minor-creditor-table-wrapper',
  table: 'tbody tr',
  ...
  accountCell: 'td[id="minorCreditorAccountNumber"]',
  nameCell: 'td[id="minorCreditorName"]',
  addressCell: 'td[id="minorCreditorAddressLine1"]',
  postcodeCell: 'td[id="minorCreditorPostcode"]',
  businessUnitCell: 'td[id="minorCreditorBusinessUnit"]',
  defendantCell: 'td[id="minorCreditorDefendant"]',
  balanceCell: 'td[id="minorCreditorBalance"]',

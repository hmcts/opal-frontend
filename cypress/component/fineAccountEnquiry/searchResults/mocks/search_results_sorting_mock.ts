...
export const SORTING_SEARCH_RESULTS_MOCK: IOpalFinesDefendantAccountResponse = {
  ...
  defendant_accounts: [
      ...
      aliases: [
        {
          ...
          alias_surname: 'WILLIAMS',
          alias_forenames: 'Sarah Jane',
        },
      ],
    ...
    },
    {
      ...
      organisation_name: null,
      defendant_title: 'Ms',
      defendant_first_names: 'Emily Rose',
    ...
    },
    {
      ...
      aliases: [
        {
          alias_number: 1,
          organisation_name: null,
          alias_surname: 'ANDERSON',
          alias_forenames: 'Lisa Marie',
        },
      ],
      ...
      organisation_name: null,
      defendant_title: 'Mrs',
      defendant_first_names: 'Lisa Marie',

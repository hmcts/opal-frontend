...
describe('Search Account Component - Individuals', () => {
  ...
  it('AC1a-d. should render the search for an account screen', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
  ...
  it('AC3a. should validate input fields and show errors', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
  ...
  it('AC3d. should show error for non-alphabetical last name', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
  ...
  it('AC3e. should show error for non-alphabetical first names', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
    ...
    cy.get(IndividualsLocators.firstNamesError).should('exist').and('contain', 'First names must only contain letters');

    cy.get(IndividualsLocators.firstNameInput).clear();
  });
  it('AC3f. should show error for invalid date of birth format', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
  ...
  it('AC3g. should show error for future date of birth', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
    individualSearchMock.fsa_search_account_individuals_search_criteria!.fsa_search_account_individuals_date_of_birth =
      '15/05/2030';
  ...
  it('AC3i. should show error for invalid NI number', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
  ...
  it('AC3j. should show error for invalid address line 1', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
  ...
  it('AC3k. should show error for invalid postcode', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
    ...
    cy.get(CommonLocators.errorSummary).should('exist').and('contain', 'Postcode must only contain letters or numbers');
  ...
  it('AC4a. should validate account number maximum field length', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
  ...
  it('AC4c. should validate last name maximum field length', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
    individualSearchMock.fsa_search_account_individuals_search_criteria!.fsa_search_account_individuals_last_name =
  ...
  it('AC4d. should validate first names maximum field length', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    individualSearchMock.fsa_search_account_individuals_search_criteria!.fsa_search_account_individuals_first_names =
  ...
  it('AC4f. should validate Address Line 1 maximum field length', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
    individualSearchMock.fsa_search_account_individuals_search_criteria!.fsa_search_account_individuals_address_line_1 =
  ...
  it('AC4g. should validate Postcode maximum field length', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
    individualSearchMock.fsa_search_account_individuals_search_criteria!.fsa_search_account_individuals_post_code =
    ...
    cy.get(CommonLocators.errorSummary).should('exist');
    cy.get(IndividualsLocators.postcodeError).should('exist').and('contain', 'Postcode must be 8 characters or fewer');
  });

  it('AC5a should validate first name field dependency', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
  ...
  it('AC5b. should validate dob field dependency', { tags: buildTags('@JIRA-STORY:PO-705') }, () => {
    setupComponent(null);
    cy.window().then((win) => {

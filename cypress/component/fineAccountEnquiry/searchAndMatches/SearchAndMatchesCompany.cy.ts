...
describe('Search Account Component - Company', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-712'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4467'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-712'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4470'] },
    () => {
      setupComponent((searchState) => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-712'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4471'] },
    () => {
      setupComponent((searchState) => {
        searchState.fsa_search_account_companies_search_criteria!.fsa_search_account_companies_company_name =
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-712'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4472'] },
    () => {
      setupComponent((searchState) => {
        searchState.fsa_search_account_companies_search_criteria!.fsa_search_account_companies_address_line_1 =
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-712'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4473'] },
    () => {
      setupComponent((searchState) => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-712'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4474'] },
    () => {
      setupComponent((searchState) => {
        searchState.fsa_search_account_companies_search_criteria!.fsa_search_account_companies_post_code = 'POSTCODES';
      });
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-1969'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4475'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-1969'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4476'] },
    () => {
      setupComponent();

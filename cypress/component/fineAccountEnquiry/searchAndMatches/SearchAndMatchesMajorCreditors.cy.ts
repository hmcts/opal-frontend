...
describe('Search Account Component - Major Creditors', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-KEY:POT-7005', '@JIRA-EPIC:PO-704'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-KEY:POT-7006', '@JIRA-EPIC:PO-704'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-KEY:POT-7007', '@JIRA-EPIC:PO-704'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-KEY:POT-7008', '@JIRA-EPIC:PO-704'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-KEY:POT-7009', '@JIRA-EPIC:PO-704'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-KEY:POT-7010', '@JIRA-EPIC:PO-704'] },
    () => {
      setupComponent((searchState) => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-KEY:POT-7011', '@JIRA-EPIC:PO-704'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-KEY:POT-7012', '@JIRA-EPIC:PO-704'] },
    () => {
      setupComponent((searchState) => {
        searchState.fsa_search_account_number = '12345678';
        searchState.fsa_search_account_reference_case_number = 'REF123';

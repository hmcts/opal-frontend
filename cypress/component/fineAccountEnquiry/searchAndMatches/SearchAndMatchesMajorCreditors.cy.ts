...
describe('Search Account Component - Major Creditors', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4502'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4503'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4504'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4505'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4506'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4507'] },
    () => {
      setupComponent((searchState) => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4508'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-716'), '@JIRA-EPIC:PO-704', '@JIRA-TEST-KEY:PO-4509'] },
    () => {
      setupComponent((searchState) => {
        searchState.fsa_search_account_number = '12345678';
        searchState.fsa_search_account_reference_case_number = 'REF123';

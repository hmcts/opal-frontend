...
describe('Global Version Control Mechanism - Component Tests', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-2140'), '@JIRA-KEY:POT-6820', '@JIRA-EPIC:PO-2239'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-2140'), '@JIRA-KEY:POT-6821', '@JIRA-EPIC:PO-2239'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-2140'), '@JIRA-KEY:POT-6822', '@JIRA-EPIC:PO-2239'] },
    () => {

...
describe('Account Enquiry Payment Terms', () => {
  ...
  it(
    ...
    () => {
      ...
      cy.get('div#root0').find('p').contains('This account has an enforcement action outstanding: DW.').should('exist');
    },
  );
  ...
  it('AC1.2ai: Display appropriate message based on defendant account status (CS)', { tags: ['PO-1801'] }, () => {
    ...
    cy.get(PAYMENT_TERMS_TAB.paymentTermsLink).contains('Change').click();
    cy.get('div#root0').find('h1').contains(' You cannot amend the payment terms of this account.').should('exist');
    cy.get('div#root0').find('p').contains('This account has been consolidated.').should('exist');
  });
  ...
  it('AC1.2ai: Display appropriate message based on defendant account status (WO)', { tags: ['PO-1801'] }, () => {
    ...
    cy.get(PAYMENT_TERMS_TAB.paymentTermsLink).contains('Change').click();
    cy.get('div#root0').find('h1').contains(' You cannot amend the payment terms of this account.').should('exist');
    cy.get('div#root0').find('p').contains('This account has been written-off.').should('exist');
  });
  ...
  it('AC1.2ai: Display appropriate message based on defendant account status (TO)', { tags: ['PO-1801'] }, () => {
    ...
    cy.get(PAYMENT_TERMS_TAB.paymentTermsLink).contains('Change').click();
    cy.get('div#root0').find('h1').contains(' You cannot amend the payment terms of this account.').should('exist');
    cy.get('div#root0').find('p').contains('This account has been transferred out.').should('exist');
  });
  ...
  it('AC1.2aii: If the account has a zero balance,', { tags: ['PO-1801'] }, () => {
    ...
    cy.get(PAYMENT_TERMS_TAB.paymentTermsLink).contains('Change').click();
    cy.get('div#root0').find('h1').contains(' You cannot amend the payment terms of this account.').should('exist');
    cy.get('div#root0').find('p').contains('The account has a zero balance.').should('exist');
  });

...
describe('Account Enquiry Enforcement Status', () => {
  ...
  it(
    'AC3a: Enforcement overview panel and collection order change link displayed with permission - Company',
    { tags: ['PO-1655'] },
    () => {
      const header = structuredClone(DEFENDANT_HEADER_MOCK);
      header.party_details.organisation_flag = true;
  ...
  it(
    'AC3b: Enforcement overview panel and collection order change link not displayed without permission - Company',
    { tags: ['PO-1655'] },
    () => {
      const header = structuredClone(DEFENDANT_HEADER_MOCK);
      header.party_details.organisation_flag = true;
  ...
  it('AC4a: Enforcement overview panel and days in default true - Company', { tags: ['PO-1655'] }, () => {
    const header = structuredClone(DEFENDANT_HEADER_MOCK);
    header.party_details.organisation_flag = true;
    header.party_details.organisation_details = {
      organisation_name: 'Test Org Ltd',
  ...
  it('AC4b: Enforcement overview panel and days in default false - Company', { tags: ['PO-1655'] }, () => {
    const header = structuredClone(DEFENDANT_HEADER_MOCK);
    header.party_details.organisation_flag = true;
    header.party_details.organisation_details = {
      organisation_name: 'Test Org Ltd',

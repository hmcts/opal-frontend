...
describe('Account Enquiry Component', () => {
  it('should mount the component', { tags: ['@PO-784'] }, () => {
    ...
    //interceptAtAGlance(accountId, OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK, '1');
    //interceptDefendantDetails(accountId, defendantDetailsMock, '1');
    interceptPGDetails(accountId, pgPartyId, pgDetailsMock, '1');

    setupComponent(accountId);
    cy.get('router-outlet').should('exist');
    //cy.get('a').contains('Parent or guardian').click();

...
describe('Account Enquiry Defendant Details Tab', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-784'), '@JIRA-KEY:POT-6768', '@JIRA-EPIC:PO-976'] },
    () => {
      let headerMock = structuredClone(DEFENDANT_HEADER_MOCK);
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-784', '@JIRA-STORY:PO-2365'), '@JIRA-KEY:POT-6769'] },
    () => {
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = false;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-784'), '@JIRA-KEY:POT-6770', '@JIRA-EPIC:PO-976'] },
    () => {
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = false;
      defendantDetailsMock.defendant_account_party.is_debtor = true;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-784'), '@JIRA-KEY:POT-6771', '@JIRA-EPIC:PO-976'] },
    () => {
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = false;
      defendantDetailsMock.defendant_account_party.is_debtor = true;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-784'), '@JIRA-KEY:POT-6772', '@JIRA-EPIC:PO-976'] },
    () => {
      let headerMock = structuredClone(DEFENDANT_HEADER_MOCK);
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = false;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-784'), '@JIRA-KEY:POT-6773', '@JIRA-EPIC:PO-976'] },
    () => {
      let headerMock = structuredClone(DEFENDANT_HEADER_MOCK);
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = false;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-784'), '@JIRA-KEY:POT-6774', '@JIRA-EPIC:PO-976'] },
    () => {
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = false;
      defendantDetailsMock.defendant_account_party.is_debtor = true;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-790'), '@JIRA-KEY:POT-6775', '@JIRA-EPIC:PO-976'] },
    () => {
      let headerMock = structuredClone(DEFENDANT_HEADER_MOCK);
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-790'), '@JIRA-KEY:POT-6776', '@JIRA-EPIC:PO-976'] },
    () => {
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = true;
      defendantDetailsMock.defendant_account_party.is_debtor = true;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-790'), '@JIRA-KEY:POT-6777', '@JIRA-EPIC:PO-976'] },
    () => {
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = true;
      defendantDetailsMock.defendant_account_party.is_debtor = true;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-790'), '@JIRA-KEY:POT-6778', '@JIRA-EPIC:PO-976'] },
    () => {
      let headerMock = structuredClone(DEFENDANT_HEADER_MOCK);
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = true;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-790'), '@JIRA-KEY:POT-6779', '@JIRA-EPIC:PO-976'] },
    () => {
      let headerMock = structuredClone(DEFENDANT_HEADER_MOCK);
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = true;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-790'), '@JIRA-KEY:POT-6780', '@JIRA-EPIC:PO-976'] },
    () => {
      let defendantDetailsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_ACCOUNT_PARTY_MOCK);
      defendantDetailsMock.defendant_account_party.party_details.organisation_flag = true;
      defendantDetailsMock.defendant_account_party.is_debtor = true;
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-1874'), '@JIRA-KEY:POT-6781', '@JIRA-EPIC:PO-1875'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-1874'), '@JIRA-KEY:POT-6782', '@JIRA-EPIC:PO-1875'] },
    () => {

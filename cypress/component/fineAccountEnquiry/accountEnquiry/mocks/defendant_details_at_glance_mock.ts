...
export const ORGANISATION_ALIASES: IOpalFinesDefendantAccountOrganisationAlias[] = [
  {
    alias_id: '1',
    organisation_name: 'Meridian Construction Ltd',
    sequence_number: 1,
  },
  {
    alias_id: '2',
    organisation_name: 'Meridian Solutions Ltd',
    sequence_number: 2,
  },
];
...
export const OPAL_FINES_ACCOUNT_ORG_AT_A_GLANCE_MOCK: IOpalFinesAccountDefendantAtAGlance = {
  version: null,
  defendant_account_id: 'DEF-001',
  account_number: 'ACC-123456',
  debtor_type: 'PERSON',

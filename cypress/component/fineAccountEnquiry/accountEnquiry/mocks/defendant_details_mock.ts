...
import { makeUserState } from './user_state_factory';
...
export const USER_STATE_MOCK_PERMISSION_ENF: IOpalUserState = {
  user_id: 50000000,
  username: 'testUserNote@HMCTS.NET',
  name: 'Test User',
  status: 'active',
...
export const USER_STATE_MOCK_PERMISSION_MAINTENANCE: IOpalUserState = {
  user_id: 50000000,
  username: 'testUserNote@HMCTS.NET',
  name: 'Test User',
  status: 'active',
...
// export const USER_STATE_MOCK_PERMISSION_BU77 = makeUserState({
//   business_unit_users: [
//     {
//       business_unit_user_id: 'LO123',
//       business_unit_id: 77,
//       permissions: [
//         {
//           permission_id: 3,

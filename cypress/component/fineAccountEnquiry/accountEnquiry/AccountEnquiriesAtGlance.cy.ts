...
describe('Defendant Account Summary - At a Glance Tab', () => {
  ...
  it('AC1,Ac1a, Ac1b: The At a Glance tab is built as per the design artefact for company', { tags: ['PO-814', '@JIRA-KEY:POT-3338'] }, () => {
  ...
  it('AC1,Ac1a, Ac1b: The At a Glance tab is built as per the design artefact for defendant', { tags: ['PO-984', '@JIRA-KEY:POT-3339'] }, () => {
      interceptUserState(USER_STATE_MOCK_PERMISSION_BU77);
  ...
  it('AC2a: Displays Language Preferences section below National Insurance Number', { tags: ['PO-984', '@JIRA-KEY:POT-3340'] }, () => {
    interceptUserState(USER_STATE_MOCK_PERMISSION_BU77);
    interceptDefendantHeader(77, createDefendantHeaderMockWithName('Robert', 'Thomson'), '1');
    interceptAtAGlance(77, OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK, '1');
  ...
  it('AC2ai: Displays Language Preferences as read-only fields', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3341'] }, () => {
    interceptUserState(USER_STATE_MOCK_PERMISSION_BU77);
    interceptDefendantHeader(77, createDefendantHeaderMockWithName('Robert', 'Thomson'), '1');
    interceptAtAGlance(77, OPAL_FINES_ACCOUNT_ORG_AT_A_GLANCE_MOCK, '1');
  ...
  it('AC2b: displays Document language and Court hearing language values in Language Preferences section', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3342'] }, () => {
      interceptUserState(USER_STATE_MOCK_PERMISSION_BU77);
      interceptDefendantHeader(77, createDefendantHeaderMockWithName('Robert', 'Thomson'), '1');
      interceptAtAGlance(77, OPAL_FINES_ACCOUNT_ORG_AT_A_GLANCE_MOCK, '1');
  ...
  it('AC2bi: Label Welsh and Language is displayed in blue', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3343'] }, () => {
    interceptUserState(USER_STATE_MOCK_PERMISSION_BU77);
    interceptDefendantHeader(77, createDefendantHeaderMockWithName('Robert', 'Thomson'), '1');
    interceptAtAGlance(77, OPAL_FINES_ACCOUNT_ORG_AT_A_GLANCE_MOCK, '1');
  ...
  it('AC3: displays Aliases section when defendant has one or more aliases', { tags: ['PO-984', '@JIRA-KEY:POT-3346'] }, () => {
    interceptUserState(USER_STATE_MOCK_PERMISSION_BU77);
    interceptDefendantHeader(77, createDefendantHeaderMockWithName('Robert', 'Thomson'), '1');
    interceptAtAGlance(77, OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK, '1');
  ...
  it('AC3b: does not display Aliases section when defendant has no aliases', { tags: ['PO-984', '@JIRA-KEY:POT-3347'] }, () => {
  ...
  it('AC3: displays Aliases section when company has one or more aliases', { tags: ['PO-814', '@JIRA-KEY:POT-3348'] }, () => {
    const header = structuredClone(DEFENDANT_HEADER_MOCK);
    header.party_details.organisation_flag = true;
    header.party_details.organisation_details = {
      organisation_name: 'Test Org Ltd',
  ...
  it('AC3b: does not display Aliases section when company has no aliases', { tags: ['PO-814', '@JIRA-KEY:POT-3349'] }, () => {
    const header = structuredClone(DEFENDANT_HEADER_MOCK);
    header.party_details.organisation_flag = true;
    header.party_details.organisation_details = {
      organisation_name: 'Test Org Ltd',
  ...
  it('AC4,AC4a: displays Comments section with no Account Comment or Free Text Notes', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3350'] }, () => {
  ...
  it('AC4b, Ac9: displays Comments section with Account Comment but no Free Text Notes', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3351'] }, () => {
      const mockDataNoComments = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK);
      mockDataNoComments.comments_and_notes = {
  ...
  it('AC4c, Ac9: displays Comments section with Free Text Notes but no Account Comment', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3352'] }, () => {
      const mockDataNoComments = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK);
      mockDataNoComments.comments_and_notes = {
        account_comment: null,
  ...
  it('AC4d: displays Comments section with both Account Comment and Free Text Notes', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3353'] }, () => {
      const mockDataNoComments = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK);
      mockDataNoComments.comments_and_notes = {
        account_comment: 'Test account comment',
        free_text_note_1: 'First note.',
  ...
  it('AC5: Shows Add comments link and navigates to Comments screen when user has Account Maintenance permission in associated  BU', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3354'] }, () => {
      const mockDataNoComments = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK);
      mockDataNoComments.comments_and_notes = {
        account_comment: null,
        free_text_note_1: null,
  ...
  it('AC5: Shows Change link and navigates to Comments screen when user has Account Maintenance permission in associated BU', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3355'] }, () => {
      const mockDataNoComments = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK);
      mockDataNoComments.comments_and_notes = {
        account_comment: 'Test account comment',
        free_text_note_1: 'first note',
  ...
  it('AC5a: Add Comment link exists when user has permission in at least one BU but not the BU associated to the account', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3356'] }, () => {
      const mockDataNoComments = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK);
      mockDataNoComments.comments_and_notes = {
        account_comment: null,
        free_text_note_1: null,
  ...
  it('AC5a: Change link exists when user has permission in at least one BU but not the BU associated to the account', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3357'] }, () => {
      interceptUserState(USER_STATE_MOCK_PERMISSION_BU17);
      interceptDefendantHeader(77, createDefendantHeaderMockWithName('Robert', 'Thomson'), '1');
      interceptAtAGlance(77, OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK, '1');
  ...
  it('AC5b: Change link and add comment do not exist when user has no permission in any BU', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3358'] }, () => {
  ...
  it('AC6a: displays Payment Terms section for "Pay by date" scenario', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3359'] }, () => {
  ...
  it('AC6b: displays Payment Terms section for "Lump sum plus instalments" scenario', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3360'] }, () => {
      interceptUserState(USER_STATE_MOCK_PERMISSION_BU77);
      interceptDefendantHeader(77, createDefendantHeaderMockWithName('Robert', 'Thomson'), '1');
      interceptAtAGlance(77, OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK, '1');
  ...
  it('AC6c: displays Payment Terms section for "Instalments only" scenario', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3361'] }, () => {
    const mockDataPayByDate = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_AT_A_GLANCE_MOCK);
    mockDataPayByDate.payment_terms = {
      payment_terms_type: {
  ...
  it('AC7a, AC7b, AC7c, AC7d: displays Last Enforcement Action field only when value is present', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3362'] }, () => {
  ...
  it('AC8a: displays blue "collection order" label when defendant is adult and CO flag is true', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3363'] }, () => {
  ...
  it('AC8b: displays red "no collection order" label when defendant is adult and CO flag is false', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3364'] }, () => {
  ...
  it('AC8c: displays red "no collection order" label when defendant is youth and CO flag is true', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3365'] }, () => {
  ...
  it('AC8d: displays no collection order label when defendant is youth and CO flag is false', { tags: ['PO-984', 'PO-814', '@JIRA-KEY:POT-3366'] }, () => {

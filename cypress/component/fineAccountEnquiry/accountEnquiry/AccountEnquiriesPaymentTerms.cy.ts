...
describe('Account Enquiry Payment Terms', () => {
  ...
  it('AC1: The Payment Terms tab is built as per the design artefact for pay in full - Adult or youth only', { tags: ['PO-1146', '@JIRA-KEY:POT-3455'] }, () => {
  ...
  it('AC1: The Payment Terms tab is built as per the design artefact for instalments only - Adult or youth only', { tags: ['PO-1146', '@JIRA-KEY:POT-3456'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC1: The Payment Terms tab is built as per the design artefact for lump sum plus instalments - Adult or youth only', { tags: ['PO-1146', '@JIRA-KEY:POT-3457'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
      paymentTermsMock.payment_terms.payment_terms_type.payment_terms_type_code = 'I';
  ...
  it('AC2: User with permission to amend payment terms, change link - Adult or youth only', { tags: ['PO-1146', '@JIRA-KEY:POT-3458'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC2: User with permission to amend payment terms in different BU, no change link - Adult or youth only', { tags: ['PO-1146', '@JIRA-KEY:POT-3459'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC2: User without permission to amend payment terms, no change link - Adult or youth only', { tags: ['PO-1146', '@JIRA-KEY:POT-3460'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC2: User with permission to amend payment terms, but cannot make amendments - extend_ttp_disallow true', { tags: ['PO-1146', '@JIRA-KEY:POT-3461'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC2: User with permission to amend payment terms, but cannot make amendments - account status CS', { tags: ['PO-1146', '@JIRA-KEY:POT-3462'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
  ...
  it('AC2: User with permission to amend payment terms, but cannot make amendments - account status WO', { tags: ['PO-1146', '@JIRA-KEY:POT-3463'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
  ...
  it('AC2: User with permission to amend payment terms, but cannot make amendments - account status TO', { tags: ['PO-1146', '@JIRA-KEY:POT-3464'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
  ...
  it('AC2: User with permission to amend payment terms, but cannot make amendments - account status TS', { tags: ['PO-1146', '@JIRA-KEY:POT-3465'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
  ...
  it('AC2: User with permission to amend payment terms, but cannot make amendments - account status TA', { tags: ['PO-1146', '@JIRA-KEY:POT-3466'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
  ...
  it('AC2: User with permission to amend payment terms, but cannot make amendments - extend_ttp_disallow true and account status CS', { tags: ['PO-1146', '@JIRA-KEY:POT-3467'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
      headerMock.account_status_reference.account_status_code = 'CS';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC3: Payment terms with amendments panel - Adult or youth only', { tags: ['PO-1146', '@JIRA-KEY:POT-3468'] }, () => {
    let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
    headerMock.debtor_type = 'individual';
    let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC1: The Payment Terms tab is built as per the design artefact for pay in full - Parent or guardian', { tags: ['PO-1636', '@JIRA-KEY:POT-3469'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
  ...
  it('AC1: The Payment Terms tab is built as per the design artefact for instalments only - Parent or guardian', { tags: ['PO-1636', '@JIRA-KEY:POT-3470'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'Parent/Guardian';
      headerMock.parent_guardian_party_id = '1770000001';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC1: The Payment Terms tab is built as per the design artefact for lump sum plus instalments - Parent or guardian', { tags: ['PO-1636', '@JIRA-KEY:POT-3471'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'Parent/Guardian';
      headerMock.parent_guardian_party_id = '1770000001';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC2: User with permission to amend payment terms, change link - Parent or guardian', { tags: ['PO-1636', '@JIRA-KEY:POT-3472'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'Parent/Guardian';
      headerMock.parent_guardian_party_id = '1770000001';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC2: User with permission to amend payment terms in different BU, no change link - Parent or guardian', { tags: ['PO-1636', '@JIRA-KEY:POT-3473'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'Parent/Guardian';
      headerMock.parent_guardian_party_id = '1770000001';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC2: User without permission to amend payment terms, no change link - Parent or guardian', { tags: ['PO-1636', '@JIRA-KEY:POT-3474'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'Parent/Guardian';
      headerMock.parent_guardian_party_id = '1770000001';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC3: Payment terms with amendments panel - Parent or guardian', { tags: ['PO-1636', '@JIRA-KEY:POT-3475'] }, () => {
    let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
    headerMock.debtor_type = 'Parent/Guardian';
    headerMock.parent_guardian_party_id = '1770000001';
    let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC1: The Payment Terms tab is built as per the design artefact for pay in full - Company', { tags: ['PO-1637', '@JIRA-KEY:POT-3476'] }, () => {
  ...
  it('AC1: The Payment Terms tab is built as per the design artefact for instalments only - Company', { tags: ['PO-1637', '@JIRA-KEY:POT-3477'] }, () => {
      const header = structuredClone(DEFENDANT_HEADER_MOCK);
      header.party_details.organisation_flag = true;
      header.party_details.organisation_details = {
        organisation_name: 'Test Org Ltd',
  ...
  it('AC1: The Payment Terms tab is built as per the design artefact for lump sum plus instalments - Company', { tags: ['PO-1637', '@JIRA-KEY:POT-3478'] }, () => {
      const header = structuredClone(DEFENDANT_HEADER_MOCK);
      header.party_details.organisation_flag = true;
      header.party_details.organisation_details = {
        organisation_name: 'Test Org Ltd',
  ...
  it('AC2: User with permission to amend payment terms, change link - Company', { tags: ['PO-1637', '@JIRA-KEY:POT-3479'] }, () => {
    const header = structuredClone(DEFENDANT_HEADER_MOCK);
    header.party_details.organisation_flag = true;
    header.party_details.organisation_details = {
      organisation_name: 'Test Org Ltd',
  ...
  it('AC2: User with permission to amend payment terms in different BU, no change link - Company', { tags: ['PO-1637', '@JIRA-KEY:POT-3480'] }, () => {
      const header = structuredClone(DEFENDANT_HEADER_MOCK);
      header.party_details.organisation_flag = true;
      header.party_details.organisation_details = {
        organisation_name: 'Test Org Ltd',
  ...
  it('AC2: User without permission to amend payment terms, no change link - Company', { tags: ['PO-1637', '@JIRA-KEY:POT-3481'] }, () => {
    const header = structuredClone(DEFENDANT_HEADER_MOCK);
    header.party_details.organisation_flag = true;
    header.party_details.organisation_details = {
      organisation_name: 'Test Org Ltd',
  ...
  it('AC3: Payment terms with amendments panel - Company', { tags: ['PO-1637', '@JIRA-KEY:POT-3482'] }, () => {
    const header = structuredClone(DEFENDANT_HEADER_MOCK);
    header.party_details.organisation_flag = true;
    header.party_details.organisation_details = {
      organisation_name: 'Test Org Ltd',
  ...
  it('AC1: Individual with permission to amend payment terms can request a payment card', { tags: ['PO-1700', '@JIRA-KEY:POT-3483'] }, () => {
    let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
    headerMock.debtor_type = 'individual';
    let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC1b: Individual with permission to amend payment terms cannot request a payment card when enforcement prevents it', { tags: ['PO-1700', '@JIRA-KEY:POT-3484'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
      paymentTermsMock.last_enforcement = 'DW';
  ...
  it('AC1a: Individual without amend payment terms permission does not see Request payment card', { tags: ['PO-1700', '@JIRA-KEY:POT-3485'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'individual';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
      paymentTermsMock.last_enforcement = 'REM';
  ...
  it('AC1: Parent or guardian can request a payment card when enforcement allows', { tags: ['PO-1701', '@JIRA-KEY:POT-3486'] }, () => {
    let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
    headerMock.debtor_type = 'Parent/Guardian';
    headerMock.parent_guardian_party_id = '1770000001';
    let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC1b: Parent or guardian cannot request a payment card when enforcement prevents it', { tags: ['PO-1701', '@JIRA-KEY:POT-3487'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'Parent/Guardian';
      headerMock.parent_guardian_party_id = '1770000001';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC1a:  Parent or guardian without amend payment terms permission does not see Request payment card', { tags: ['PO-1701', '@JIRA-KEY:POT-3488'] }, () => {
      let headerMock = structuredClone(createDefendantHeaderMockWithName('Robert', 'Thomson'));
      headerMock.debtor_type = 'Parent/Guardian';
      headerMock.parent_guardian_party_id = '1770000001';
      let paymentTermsMock = structuredClone(OPAL_FINES_ACCOUNT_DEFENDANT_DETAILS_PAYMENT_TERMS_LATEST_MOCK);
  ...
  it('AC1: Company can request a payment card when enforcement allows', { tags: ['PO-1702', '@JIRA-KEY:POT-3489'] }, () => {
    const header = structuredClone(DEFENDANT_HEADER_MOCK);
    header.party_details.organisation_flag = true;
    header.party_details.organisation_details = {
      organisation_name: 'Test Org Ltd',
  ...
  it('AC1b: Company cannot request a payment card when enforcement prevents it', { tags: ['PO-1702', '@JIRA-KEY:POT-3490'] }, () => {
    const header = structuredClone(DEFENDANT_HEADER_MOCK);
    header.party_details.organisation_flag = true;
    header.party_details.organisation_details = {
      organisation_name: 'Test Org Ltd',
  ...
  it('AC1a:  Company without amend payment terms permission does not see Request payment card', { tags: ['PO-1702', '@JIRA-KEY:POT-3491'] }, () => {
      const header = structuredClone(DEFENDANT_HEADER_MOCK);
      header.party_details.organisation_flag = true;
      header.party_details.organisation_details = {
        organisation_name: 'Test Org Ltd',

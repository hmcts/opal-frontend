...
export const FINES_COMP_CHECK_ACCOUNT_MOCK: IFinesMacState = {
  accountDetails: {
  ...
  companyDetails: {
    ...
    formData: {
      fm_company_details_company_name: 'Company Name',
      fm_company_details_address_line_1: '123 Fake Street',
      fm_company_details_address_line_2: 'Fake Town',
      fm_company_details_address_line_3: 'Fake City',

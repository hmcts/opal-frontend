...
export const FINES_AYPG_CHECK_ACCOUNT_MOCK: IFinesMacState = {
  accountDetails: {
  ...
  parentGuardianDetails: {
    ...
    formData: {
      ...
      fm_parent_guardian_details_surname: 'parent',
      ...
      fm_parent_guardian_details_address_line_1: 'address line 1',
      fm_parent_guardian_details_address_line_2: 'address line 2',
      fm_parent_guardian_details_address_line_3: 'address line 3',
      fm_parent_guardian_details_post_code: 'AB12 3CD',
      fm_parent_guardian_details_vehicle_make: 'FORD',
      fm_parent_guardian_details_vehicle_registration_mark: 'AB12 CDE',
    },
  },
  personalDetails: {

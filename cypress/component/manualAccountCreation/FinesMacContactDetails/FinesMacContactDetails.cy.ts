...
describe('FinesMacContactDetailsComponent', () => {
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4080'] },
    () => {
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4081'] },
    () => {
      setupComponent(null, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4082'] },
    () => {
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4083'] },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@PO-344', '@PO-370', '@JIRA-KEY:POT-4084'] },
    () => {
  ...
  it(
    ...
    { tags: ['@PO-345', '@PO-371', '@JIRA-KEY:POT-4085'] },
    () => {
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4086'] },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4087'] },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4088'] },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4089'] },
    () => {
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4090'] },
    () => {
      const invalidEmails = ['test-test-com', 'test@test', 'test.com', 'test@.com', 'test@com'];
      cy.wrap(invalidEmails).each((email: string) => {
        cy.then(() => {
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4091'] },
    () => {
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4092'] },
    () => {
      const invalidPhoneNumbers = ['123456789', '123456789012', '1234567890a'];
      cy.wrap(invalidPhoneNumbers).each((number: string) => {
        cy.then(() => {
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4093'] },
    () => {
      const invalidPhoneNumbers = ['123456789', '123456789012', '1234567890a'];
      cy.wrap(invalidPhoneNumbers).each((number: string) => {
        cy.then(() => {
  ...
  it(
    ...
    { tags: ['@PO-272', '@PO-419', '@JIRA-KEY:POT-4094'] },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();

...
describe('FinesMacEmployerDetailsComponent', () => {
  ...
  it('should render the component for AY', { tags: buildTags('@JIRA-STORY:PO-272', '@JIRA-STORY:PO-280') }, () => {
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-272', '@JIRA-STORY:PO-280') },
    () => {
      setupComponent(null, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-272', '@JIRA-STORY:PO-434') },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();
      setupComponent(formSubmitSpy, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-344', '@JIRA-STORY:PO-435') },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();

...
describe('FinesMacEmployerDetailsComponent', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-280'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4969'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-280'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4970'] },
    () => {
      setupComponent(null, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-280'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4971'] },
    () => {
      setupComponent(null, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-280'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4972'] },
    () => {
      setupComponent(null, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-280'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4974'] },
    () => {
      setupComponent(null, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-280'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4976'] },
    () => {
      setupComponent(null, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-280'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4977'] },
    () => {
      setupComponent(null, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-280'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4978'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-280'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4979'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-280'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4980'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-434'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4982'] },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();
      setupComponent(formSubmitSpy, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-435'), '@JIRA-EPIC:PO-344', '@JIRA-TEST-KEY:PO-4983'] },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-1449'), '@JIRA-EPIC:PO-344', '@JIRA-TEST-KEY:PO-4984'] },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();
      setupComponent(formSubmitSpy, 'pgToPay');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-1448'), '@JIRA-EPIC:PO-272', '@JIRA-TEST-KEY:PO-4985'] },
    () => {
      setupComponent(null, 'adultOrYouthOnly');

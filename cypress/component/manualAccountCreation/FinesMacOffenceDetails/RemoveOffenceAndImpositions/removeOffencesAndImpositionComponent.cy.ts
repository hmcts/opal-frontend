...
import { MacOffenceDetailsRemoveOffenceAndImpositionsLocators as DOM_ELEMENTS } from '../../../../shared/selectors/manual-account-creation/mac.offence-details.locators';
...
describe('RemoveOffenceAndImpositionsComponent', () => {
  ...
  it(
    ...
    { tags: ['@PO-416', '@PO-682', '@PO-680', '@PO-545', '@JIRA-KEY:POT-4214'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: ['@PO-416', '@PO-682', '@PO-680', '@PO-545', '@JIRA-KEY:POT-4216'] },
    () => {
      setupComponent();

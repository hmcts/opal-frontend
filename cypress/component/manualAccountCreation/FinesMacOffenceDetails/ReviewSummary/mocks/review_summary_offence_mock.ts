...
import { FINES_REVIEW_SUMMARY_IMPOSITION_MOCK } from './review_summary_imposition_mock';

export const FINES_REVIEW_SUMMARY_OFFENCE_MOCK: IFinesMacState = {
  accountDetails: {
  ...
  offenceDetails: [
    {
      ...
      formData: {
        ...
        fm_offence_details_date_of_sentence: '01/10/2021',
        fm_offence_details_offence_cjs_code: 'AK123456',
        fm_offence_details_offence_id: null,
        fm_offence_details_impositions: [FINES_REVIEW_SUMMARY_IMPOSITION_MOCK[0]],
      },
      nestedFlow: false,
    },
    {
      ...
      formData: {
        ...
        fm_offence_details_date_of_sentence: '01/10/2023',
        fm_offence_details_offence_cjs_code: 'CA03010D',
        fm_offence_details_offence_id: null,
        fm_offence_details_impositions: [FINES_REVIEW_SUMMARY_IMPOSITION_MOCK[1]],
      },
      nestedFlow: false,
    },
  ],

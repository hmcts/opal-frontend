...
describe('ReviewSummaryComponent', () => {
  ...
  it('should load all elements on the screen', () => {
    setupComponent();
  ...
  it('should display the correct data in the elements', () => {
    setupComponent();
    ...
    cy.get(DOM_ELEMENTS.GrandtotalRemainingBalance).should('contain', '£430.00').should('contain', 'Balance remaining');
  ...
  it('should have updated values for different set of impositions and reflect correct totals and balances', () => {
    ...
    cy.get(DOM_ELEMENTS.GrandtotalRemainingBalance).should('contain', '£700.00').should('contain', 'Balance remaining');
  });
  ...
  it('should be able to hide and show impositions', () => {
    setupComponent();

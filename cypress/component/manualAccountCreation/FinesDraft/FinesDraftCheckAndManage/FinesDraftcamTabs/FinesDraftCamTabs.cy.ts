...
describe('FinesDraftCheckAndManageTabsComponent', () => {
  ...
  it(
    '(AC.1,AC.3,AC.4,AC.5) should render all elments in the component for all links with valid data',
    { tags: ['@PO-584', '@PO-605'] },
    () => {
  ...
  it(
    '(AC.1) should show number of rejected accounts in a icon dependant on count variable on rejected status',
    { tags: ['@PO-605'] },
    () => {
      setupComponent();
  ...
  it(
    '(AC.1) should show only allow number of rejected account count to go up to 99 then after display 99+',
    { tags: ['@PO-605'] },
    () => {
      setupComponent();
  ...
  it(
    'should show empty value statement for Approved status when no accounts have been Approved',
    { tags: ['@PO-584'] },
    () => {
      setupComponent();
  ...
  it(
    'should show empty value statement for Deleted status when no accounts have been Deleted',
    { tags: ['@PO-584'] },
    () => {
      setupComponent();

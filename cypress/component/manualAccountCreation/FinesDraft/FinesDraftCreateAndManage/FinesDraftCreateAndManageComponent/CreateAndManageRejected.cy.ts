...
describe('FinesDraftCreateAndManageRejectedComponent', () => {
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-605') },
    () => {
  ...
  it('AC.4 verify the table of headers in review tab', { tags: buildTags('@JIRA-STORY:PO-605') }, () => {
    const rejectedMockData = { count: 2, summaries: OPAL_FINES_DRAFT_ACCOUNTS_MOCK.summaries };
  ...
  it('(AC.5a) The table should have the correct default ordering', { tags: buildTags('@JIRA-STORY:PO-605') }, () => {
    const rejectedMockData = { count: 2, summaries: OPAL_FINES_DRAFT_ACCOUNTS_MOCK.summaries };

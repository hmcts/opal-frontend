...
describe('FinesDraftCreateAndManageHeaderComponent', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-2762'), '@JIRA-KEY:POT-7175', '@JIRA-EPIC:PO-2750'] },
    () => {
      stubAllTabResponses();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-2762'), '@JIRA-KEY:POT-7176', '@JIRA-EPIC:PO-2750'] },
    () => {
      stubAllTabResponses();
      cy.then(() => {
        mount(FinesDraftCreateAndManageTabsComponent, {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-2762'), '@JIRA-KEY:POT-7177', '@JIRA-EPIC:PO-2750'] },
    () => {
      stubAllTabResponses();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-2762'), '@JIRA-KEY:POT-7178', '@JIRA-EPIC:PO-2750'] },
    () => {
      stubAllTabResponses();
      setupComponent(DRAFT_SESSION_USER_STATE_INPUTTER_MOCK);

...
describe('FinesDraftCreateAndManageApprovedComponent', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-607'), '@JIRA-KEY:POT-7167', '@JIRA-EPIC:PO-2220'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-607'), '@JIRA-KEY:POT-7168', '@JIRA-EPIC:PO-2220'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-607'), '@JIRA-KEY:POT-7169', '@JIRA-EPIC:PO-2220'] },
    () => {

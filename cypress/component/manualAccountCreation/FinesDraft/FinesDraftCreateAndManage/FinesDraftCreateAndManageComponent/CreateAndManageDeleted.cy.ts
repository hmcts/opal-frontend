...
describe('FinesDraftCreateAndManageDeletedComponent', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-609'), '@JIRA-KEY:POT-7170', '@JIRA-EPIC:PO-2220'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-609'), '@JIRA-KEY:POT-7171', '@JIRA-EPIC:PO-2220'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-609'), '@JIRA-KEY:POT-7172', '@JIRA-EPIC:PO-2220'] },
    () => {
      const deletedAccountsMockData = structuredClone(OPAL_FINES_DRAFT_DELETE_ACCOUNTS_MOCK);
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-609'), '@JIRA-KEY:POT-7173', '@JIRA-EPIC:PO-2220'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-609'), '@JIRA-KEY:POT-7174', '@JIRA-EPIC:PO-2220'] },
    () => {
      const deletedAccountsMockData = structuredClone(OPAL_FINES_DRAFT_DELETE_ACCOUNTS_MOCK);

...
describe('FinesDraftCreateAndManageViewAllRejectedComponent', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-618'), '@JIRA-KEY:POT-7192', '@JIRA-EPIC:PO-2220'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-618'), '@JIRA-KEY:POT-7193', '@JIRA-EPIC:PO-2220'] },
    () => {
      const allRejectedMockData = structuredClone(OPAL_FINES_DRAFT_ACCOUNTS_MOCK);
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-618'), '@JIRA-KEY:POT-7194', '@JIRA-EPIC:PO-2220'] },
    () => {
      const allRejectedMockData = structuredClone(OPAL_FINES_DRAFT_ACCOUNTS_MOCK);
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-STORY:PO-618'), '@JIRA-KEY:POT-7195', '@JIRA-EPIC:PO-2220'] },
    () => {

...
describe('FinesMacReviewFixedPenalty using ReviewAccountComponent', () => {
  ...
  it(
    'should display tables in correct order and correct content for adult/youth (AC2, AC2a)',
    { tags: ['@PO-861'] },
    () => {
  ...
  it(
    'should display Welsh language preferences Business Unit supports Welsh (AdultOrYouthOnly)',
    { tags: ['@PO-861'] },
    () => {
      setupComponent(FINES_DRAFT_STATE, 'adultOrYouthOnly');
  ...
  it(
    'should display Welsh language preferences when Business Unit supports Welsh (Company)',
    { tags: ['@PO-861'] },
    () => {
  ...
  it(
    'should display tables in correct order and correct content for company defendant (AC2, AC2a)',
    { tags: ['@PO-861'] },
    () => {
      setupComponent(FINES_DRAFT_STATE, 'company');
  ...
  it(
    'should display an em-dash for unpopulated fields in company defendant view (AC2bi)',
    { tags: ['@PO-861'] },
    () => {
      setupComponent(FINES_DRAFT_STATE, 'company');

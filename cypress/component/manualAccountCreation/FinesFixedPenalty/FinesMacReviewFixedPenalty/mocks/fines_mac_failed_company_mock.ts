export const FIXED_PENALTY_FAILED_DRAFT_COMPANY_MOCK = {
  ...
  account: {
    ...
    account_sentence_date: '2025-11-01',
    defendant: {
      company_flag: true,
      title: null,
      surname: null,
      forenames: null,
      company_name: 'Argent Oak Solutions Ltd',
      dob: null,
      address_line_1: 'Fake company',
      address_line_2: null,
      address_line_3: null,
      address_line_4: null,
      address_line_5: null,
    ...
    fp_ticket_detail: {
      notice_number: '12345',
      date_of_issue: '2025-11-01',
      time_of_issue: '05:40',
      fp_registration_number: 'FV53RTO',
      notice_to_owner_hirer: '45678',
    ...
    account_notes: [
      {
        ...
        account_note_text: 'Add Comment ',
        note_type: 'AC',
      },
      {
        account_note_serial: 2,
        account_note_text: 'Add Account note',
        note_type: 'AA',
      },
    ],
  },
  account_type: 'Fixed Penalty',
  account_status: 'Publishing Failed',

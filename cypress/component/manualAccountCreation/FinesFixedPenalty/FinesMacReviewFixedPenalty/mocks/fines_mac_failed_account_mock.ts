export const FIXED_PENALTY_FAILED_DEFENDANT_MOCK = {
  ...
  account: {
    ...
    fp_ticket_detail: {
      notice_number: '12345',
      date_of_issue: '2025-11-13',
      time_of_issue: '05:00',
      fp_registration_number: 'FV53TCO',
      notice_to_owner_hirer: '123343',
      place_of_offence: 'William Street',
    ...
    account_notes: [
      ...
      },
      {
        ...
        account_note_text: 'Add Account Notes',
        note_type: 'AA',
      },
    ],
  },

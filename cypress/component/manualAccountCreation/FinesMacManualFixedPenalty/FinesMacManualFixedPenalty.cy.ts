...
describe('FinesMacManualFixedPenalty', () => {
  ...
  it('(AC1a-eii) The Fixed Penalty Details screen will be created as per the Design Artefacts', { tags: ['@PO-857'] }, () => {
    ...
    // AC1e - For the Offence Code field, a user can only search via entering an Offence code
    cy.get(DOM_ELEMENTS.offenceCodeInput).clear().type('CJ03');
    cy.get('[role="listbox"]').should('be.visible');
    cy.get('[role="option"]').should('contain', 'CJ03507');
  ...
  it('(AC3) Validation will exist for the Enforcement Court field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'The defendant\'s first name(s) must be 20 characters or fewer');
    
    // User enters non-alphabetical characters
    cy.get(DOM_ELEMENTS.firstNameInput).clear().type('John123@#$', {delay: 0});
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'The defendant\'s first name(s) must only contain alphabetical text');
  ...
  it('(AC6) Validation will exist for the Last name field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'The defendant\'s last name must only contain alphabetical text');
  });
  ...
  it('(AC11) Validation will exist for the Postcode field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Postcode must only include letters a to z, numbers, hyphens, spaces and apostrophes');
    
    // User enters an invalid postcode TBC
    cy.get(DOM_ELEMENTS.postcodeInput).clear().type('INVALID', {delay: 0});
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Enter postcode in the correct format, like TBD');
  });
  ...
  it('(AC12) Validation will exist for the Notice number field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Notice number must only include letters a to z, numbers, hyphens, spaces and apostrophes');
  });
  ...
  it('(AC13) Validation will exist for the Registration number field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Registration number must only include letters a to z, numbers, hyphens, spaces and apostrophes');
  });
  ...
  it('(AC14) Validation will exist for the Driving licence number field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Driving licence number must be in a valid format (I.e. first 5 characters are the surname, second 6 are the DOB, 2 characters for the initials and 3 random characters)');
  ...
  it('(AC15) Validation will exist for the Notice to owner or hirer number (NTO/NTH) field', { tags: ['@PO-857'] }, () => {
    setupComponent();
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Notice to owner or hirer number (NTO/NTH) must be 10 characters or fewer');
    
    // User enters non-alphanumeric characters
    cy.get(DOM_ELEMENTS.ntoNthInput).clear().type('NTO$%^&*', {delay: 0});
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Notice to owner or hirer number (NTO/NTH) must only include letters a to z, numbers, hyphens, spaces and apostrophes');
  });
  ...
  it('(AC17) Validation will exist for the Date of offence field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.dateOfOffenceInput).clear({force: true}).type('abc/de/fghi', {force: true, delay: 0});
    cy.get(DOM_ELEMENTS.submitButton).click();
  ...
  it('(AC18) Validation will exist for the Offence code field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Offence code must be 8 characters or fewer');
    
    // User enters non-alphanumeric characters
    cy.get(DOM_ELEMENTS.offenceCodeInput).clear().type('CJ03$%^&*', {delay: 0});
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Offence code must only include letters a to z, numbers, hyphens, spaces and apostrophes');
  });
  ...
  it('(AC19) Validation will exist for the Time of offence field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Enter time of offence in the correct format, such as 02:00 or 14:00');
  ...
  it('(AC20) Validation will exist for the Place of offence field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Place of offence must only include letters a to z, numbers, hyphens, spaces and apostrophes');
  });
  ...
  it('(AC21) Validation will exist for the Amount imposed field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Amount too long. Enter an amount that is less than 18 numbers before the decimal and 2 or less after');
  ...
  it('(AC22) Validation will exist for the Add comment field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Add comment must only include letters a to z, numbers, hyphens, spaces and apostrophes');
  });
  ...
  it('(AC23) Validation will exist for the Add account note field', { tags: ['@PO-857'] }, () => {
    ...
    cy.get(DOM_ELEMENTS.submitButton).click();
    cy.get(DOM_ELEMENTS.errorSummaryList).should('contain', 'Add account note must only include letters a to z, numbers, hyphens, spaces and apostrophes');
  });
});
...
describe('FinesMacReviewAccountComponent - View Deleted Account', () => {
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-603', '@JIRA-STORY:PO-2767') },
    () => {
  ...
  it('AC.3 - should render Delete History section correctly', { tags: buildTags('@JIRA-STORY:PO-603') }, () => {
    let fetchMap = structuredClone(reviewAccountFetchMap);
    fetchMap.finesMacDraft.account_status = 'Deleted';
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-603') },
    () => {
      let fetchMap = structuredClone(reviewAccountFetchMap);
      fetchMap.finesMacDraft.account_status = 'Deleted';
  ...
  it('(AC2,.5) should render all elements on the screen for AYPG', { tags: buildTags('@JIRA-STORY:PO-603') }, () => {
    let fetchMap = structuredClone(reviewAccountFetchMap);
    fetchMap.finesMacDraft.account_status = 'Deleted';
  ...
  it('AC.7 - should show em-dash for empty values', { tags: buildTags('@JIRA-STORY:PO-603') }, () => {
    let fetchMap = structuredClone(reviewAccountFetchMap);
    fetchMap.finesMacDraft.account_status = 'Deleted';

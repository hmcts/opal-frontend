...
describe('FinesMacReviewAccountComponent', () => {
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-560', '@JIRA-STORY:PO-272', '@JIRA-STORY:PO-657') },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-662', '@JIRA-STORY:PO-344', '@JIRA-STORY:PO-657') },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-662', '@JIRA-STORY:PO-344') },
    () => {
      setupComponent();
      finesMacState.accountDetails.formData.fm_create_account_defendant_type = 'pgToPay';
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-663', '@JIRA-STORY:PO-345', '@JIRA-STORY:PO-657') },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-610', '@JIRA-STORY:PO-584') },
    () => {
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-2093') },
    () => {
      finesMacState.accountDetails.formData.fm_create_account_defendant_type = 'pgToPay';
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-2240') },
    () => {
      setupComponent(finesDraftState, null, false, false);
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-1988', '@JIRA-STORY:PO-2092') },
    () => {
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-2793') },
    () => {

...
import { SESSION_USER_STATE_MOCK } from 'src/app/services/session-service/mocks/session-user-state.mock';
...
describe('FinesMacReviewAccountComponent', () => {
  ...
  it(
    ...
    { tags: ['@PO-560', '@PO-272', '@PO-610', '@PO-657'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: ['@PO-662', '@PO-344', '@PO-610', '@PO-657'] },
    () => {
      setupComponent();
  ...
  it(
    ...
    { tags: ['@PO-663', '@PO-345', '@PO-610', '@PO-657'] },
    () => {
      setupComponent();

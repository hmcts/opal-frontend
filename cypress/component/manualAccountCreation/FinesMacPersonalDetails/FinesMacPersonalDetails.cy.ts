...
describe('FinesMacPersonalDetailsComponent', () => {
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-272', '@JIRA-STORY:PO-360') },
    () => {
      setupComponent(null);
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-272', '@JIRA-STORY:PO-433') },
    () => {
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-344', '@JIRA-STORY:PO-369') },
    () => {
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-272', '@JIRA-STORY:PO-502') },
    () => {
      setupComponent(null, 'adultOrYouthOnly');
  ...
  it(
    ...
    { tags: buildTags('@JIRA-STORY:PO-344', '@JIRA-STORY:PO-505') },
    () => {
      setupComponent(null, 'pgToPay');

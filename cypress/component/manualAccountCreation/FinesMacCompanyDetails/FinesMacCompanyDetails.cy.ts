...
describe('FinesMacCompanyDetailsComponent', () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7323'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7324'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7325'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7326'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7327'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7328'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7329'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7330'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7331'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7332'] },
    () => {
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7333'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7334'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7335'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7336'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7337'] },
    () => {
      setupComponent(null, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7338'] },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-365'), '@JIRA-KEY:POT-7339'] },
    () => {
      const formSubmitSpy = Cypress.sinon.spy();
      setupComponent(formSubmitSpy, 'company');
  ...
  it(
    ...
    { tags: [...buildTags('@JIRA-EPIC:PO-345', '@JIRA-STORY:PO-1450'), '@JIRA-KEY:POT-7340'] },
    () => {
      setupComponent(null, 'company');

...
export const CONFISCATION_PERSONAL_DETAILS_FIELD_ERRORS: IConfiscationPersonalDetailsFieldErrors = {
  conf_personal_details_title: {
    required: {
      message: 'Select a title',
      priority: 1,
    },
  },
  conf_personal_details_forenames: {
    required: {
  ...
  conf_personal_details_alias_forenames_0: {
    required: {
  ...
  conf_personal_details_alias_surname_0: {
    required: {
  ...
  conf_personal_details_alias_forenames_1: {
    required: {
  ...
  conf_personal_details_alias_surname_1: {
    required: {
  ...
  conf_personal_details_alias_forenames_2: {
    required: {
  ...
  conf_personal_details_alias_surname_2: {
    required: {
  ...
  conf_personal_details_alias_forenames_3: {
    required: {
  ...
  conf_personal_details_alias_surname_3: {
    required: {
  ...
  conf_personal_details_alias_forenames_4: {
    required: {
  ...
  conf_personal_details_alias_surname_4: {
    required: {
  ...
  conf_personal_details_address_line_2: {
    maxlength: {
  ...
  conf_personal_details_address_line_3: {
    maxlength: {
  ...
  conf_personal_details_post_code: {
    maxlength: {
      message: `The postcode must be 8 characters or fewer`,
      priority: 1,
    },
  },
  conf_personal_details_vehicle_make: {
    maxlength: {
      message: `The make of car must be 30 characters or fewer`,
      priority: 1,
    },
  },
  conf_personal_details_vehicle_registration_mark: {
    maxlength: {

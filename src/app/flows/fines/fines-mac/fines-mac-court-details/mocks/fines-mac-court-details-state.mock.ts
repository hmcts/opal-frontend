...
export const FINES_MAC_COURT_DETAILS_STATE_MOCK: IFinesMacFormState = {
  [F_M_COURT_DETAILS_SENDING_COURT.controlName]: 'Asylum & Immigration Tribunal (9985)',
  [F_M_COURT_DETAILS_PROSECUTOR_COURT_REFERENCE.controlName]: 'O1AT204003',
  [F_M_COURT_DETAILS_ENFORCING_COURT.controlName]: 'Historic Debt Database (101)',
};

...
import { FINES_MAC_CREATE_ACCOUNT_CONFIGURATION_ITEMS } from './constants/fines-mac-create-account-configuration-items.constant';
...
export class FinesMacCreateAccountComponent extends AbstractFormParentBaseComponent implements OnInit {
  ...
  public handleAccountDetailsSubmit(form: IFinesMacAccountDetailsForm): void {
    ...
    if (form.formData.fm_create_account_account_type === FINES_ACCOUNT_TYPES['Fixed Penalty']) {
  ...
  public ngOnInit(): void {
    ...
    const originatorType = this.finesMacStore.originatorType();

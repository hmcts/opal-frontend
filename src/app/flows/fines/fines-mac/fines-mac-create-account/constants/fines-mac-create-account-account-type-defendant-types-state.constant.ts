...
import { FINES_MAC_CREATE_ACCOUNT_DEFENDANT_TYPES } from './fines-mac-create-account-defendant-types.constant';
...
export const FINES_MAC_CREATE_ACCOUNT_ACCOUNT_TYPE_DEFENDANT_TYPES_STATE: IFinesMacAccountTypeDefendantTypes = {
  Fine: {
    ...
    pgToPay: FINES_MAC_CREATE_ACCOUNT_DEFENDANT_TYPES[FINES_MAC_DEFENDANT_TYPES_KEYS.pgToPay],

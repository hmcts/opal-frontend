...
export const FINES_MAC_PARENT_GUARDIAN_DETAILS_STATE_MOCK: IFinesMacParentGuardianDetailsState = {
  fm_parent_guardian_details_forenames: 'Test Forenames',
  fm_parent_guardian_details_surname: 'Test Surname',
  ...
  fm_parent_guardian_details_national_insurance_number: 'QQ 12 34 56 C',

...
export interface IFinesMacCompanyDetailsFieldErrors extends IAbstractFormBaseFieldErrors {
  fm_company_details_organisation_name: IAbstractFormBaseFieldError;
  fm_company_details_alias_organisation_name_0: IAbstractFormBaseFieldError;
  fm_company_details_alias_organisation_name_1: IAbstractFormBaseFieldError;
  fm_company_details_alias_organisation_name_2: IAbstractFormBaseFieldError;
  fm_company_details_alias_organisation_name_3: IAbstractFormBaseFieldError;
  fm_company_details_alias_organisation_name_4: IAbstractFormBaseFieldError;

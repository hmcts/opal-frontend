import { FINES_MAC_PAYMENT_TERMS_INSTALMENTS_ONLY_CONTROL_VALIDATION as FM_PAYMENT_TERMS_INSTALMENT_CONTROLS } from './fines-mac-payment-terms-instalments-only-control-validation';
...
export const FINES_MAC_PAYMENT_TERMS_LUMP_SUM_CONTROL_VALIDATION: IAbstractFormArrayControlValidation[] = [
  {
    controlName: 'fm_payment_terms_lump_sum',
    validators: [Validators.required, twoDecimalPlacesValidator()],
  },
  ...FM_PAYMENT_TERMS_INSTALMENT_CONTROLS,
];

export interface IFinesMacOffenceDetailsMinorCreditorState {
  ...
  fm_offence_details_minor_creditor_surname: string | null;
  fm_offence_details_minor_creditor_company_name: string | null;
  fm_offence_details_minor_creditor_address_line_1: string | null;

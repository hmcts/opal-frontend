...
describe('FinesMacPayloadService', () => {
  ...
  it('should create an individual payload', () => {
    ...
    finesMacState.accountDetails.formData = accountDetailsState;
    finesMacState.personalDetails.formData = personalDetailsState;
    finesMacState.contactDetails.formData = contactDetailsState;
    finesMacState.employerDetails.formData = employerDetailsState;
    finesMacState.languagePreferences.formData = languagePreferencesState;
    finesMacState.companyDetails.formData = companyDetailsState;
    finesMacState.parentGuardianDetails.formData = parentGuardianDetailsState;

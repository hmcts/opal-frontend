...
const buildAccountOffencesImpositionsPayload = (
  ...
  return impositions.map((imposition) => {
    const impositionId = imposition.fm_offence_details_imposition_id;
    ...
    return {
      result_id: imposition.fm_offence_details_result_code,
      amount_imposed: imposition.fm_offence_details_amount_imposed,
      amount_paid: imposition.fm_offence_details_amount_paid,
      major_creditor_id: imposition.fm_offence_details_major_creditor,

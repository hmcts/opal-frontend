...
export const FINES_MAC_PAYLOAD_EMPLOYER_DETAILS_STATE_MOCK: IFinesMacEmployerDetailsState = {
  ...
  fm_employer_details_employer_telephone_number: '02012345678',
  fm_employer_details_employer_address_line_1: '789 Innovation Street',
  fm_employer_details_employer_address_line_2: 'Suite 300',
  fm_employer_details_employer_address_line_3: 'Tech City',
  fm_employer_details_employer_address_line_4: 'Eastside',
  fm_employer_details_employer_address_line_5: 'Middleshire',
  fm_employer_details_employer_post_code: 'BT22 4KL',
};

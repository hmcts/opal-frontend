...
import {
  FINES_MAC_PAYLOAD_ACCOUNT_PAYMENT_TERMS_IN_FULL_MOCK,
  FINES_MAC_PAYLOAD_ACCOUNT_PAYMENT_TERMS_INSTALMENTS_MOCK,
  FINES_MAC_PAYLOAD_ACCOUNT_PAYMENT_TERMS_LUMP_SUM_PLUS_INSTALMENTS_MOCK,
  FINES_MAC_PAYLOAD_ACCOUNT_PAYMENT_TERMS_NULL_MOCK,
} from './mocks/fines-mac-payload-account-payment-terms-state.mock';
...
describe('buildAccountPaymentTermsPayload', () => {
  it('should build payment terms payload for payInFull, collection order made, payment card request, default days in jail, PRIS Enforcement', () => {
    const paymentTermsState: IFinesMacPaymentTermsState = FINES_MAC_PAYLOAD_ACCOUNT_PAYMENT_TERMS_IN_FULL_MOCK;
  ...
  it('should build payment terms payload for instalments, card request, hold enforcement on account', () => {
    const paymentTermsState: IFinesMacPaymentTermsState = FINES_MAC_PAYLOAD_ACCOUNT_PAYMENT_TERMS_INSTALMENTS_MOCK;
    const expectedPayload: IFinesMacPayloadAccountPaymentTerms = {
  ...
  it('should build payment terms payload but the response payload should be null', () => {
    const paymentTermsState: IFinesMacPaymentTermsState = FINES_MAC_PAYLOAD_ACCOUNT_PAYMENT_TERMS_NULL_MOCK;
    const expectedPayload: IFinesMacPayloadAccountPaymentTerms = {

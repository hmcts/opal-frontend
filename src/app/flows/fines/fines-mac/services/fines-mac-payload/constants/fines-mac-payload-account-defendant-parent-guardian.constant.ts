import { IFinesMacPayloadAccountDefendantParentGuardianComplete } from '../utils/fines-mac-payload-build-account/interfaces/fines-mac-payload-account-defendant-parent-guardian-complete.interface';

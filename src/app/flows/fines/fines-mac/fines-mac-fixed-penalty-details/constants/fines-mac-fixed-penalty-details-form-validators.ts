...
export const FINES_MAC_FIXED_PENALTY_DETAILS_FORM_VALIDATORS: IFinesMacFixedPenaltyDetailsFormValidators = {
  ...
  fm_fp_personal_details_forenames: [Validators.required, Validators.maxLength(20), alphabeticalTextValidator()],
  fm_fp_personal_details_surname: [Validators.required, Validators.maxLength(30), alphabeticalTextValidator()],
  ...
  fm_fp_company_details_company_name: [Validators.required, Validators.maxLength(30), alphabeticalTextValidator()],

...
export const FINES_MAC_FIXED_PENALTY_DETAILS_FIELD_ERRORS: IFinesMacFixedPenaltyDetailsFieldErrors = {
  ...
  fm_fp_personal_details_alias_forenames_0: {
    required: {
  ...
  fm_fp_personal_details_alias_surname_0: {
    required: {
  ...
  fm_fp_personal_details_alias_forenames_1: {
    required: {
  ...
  fm_fp_personal_details_alias_surname_1: {
    required: {
  ...
  fm_fp_personal_details_alias_forenames_2: {
    required: {
  ...
  fm_fp_personal_details_alias_surname_2: {
    required: {
  ...
  fm_fp_personal_details_alias_forenames_3: {
    required: {
  ...
  fm_fp_personal_details_alias_surname_3: {
    required: {
  ...
  fm_fp_personal_details_alias_forenames_4: {
    required: {
  ...
  fm_fp_personal_details_alias_surname_4: {
    required: {
  ...
  fm_fp_personal_details_national_insurance_number: {
  ...
  fm_fp_personal_details_vehicle_make: {
    maxlength: {
      message: `The make of car must be 30 characters or fewer`,
      priority: 1,
    },
  },
  fm_fp_personal_details_vehicle_registration_mark: {
    maxlength: {

...
export const FINES_MAC_CONTACT_DETAILS_FIELD_ERRORS: IAbstractFormBaseFieldErrors = {
  [FM_CONTACT_DETAILS_EMAIL_ADDRESS_ONE.controlName]: {
    maxlength: {
  ...
  [FM_CONTACT_DETAILS_EMAIL_ADDRESS_TWO.controlName]: {
    maxlength: {
  ...
  [FM_CONTACT_DETAILS_TELEPHONE_NUMBER_MOBILE.controlName]: {
    maxlength: {
  ...
  [FM_CONTACT_DETAILS_TELEPHONE_NUMBER_HOME.controlName]: {
    maxlength: {
  ...
  [FM_CONTACT_DETAILS_TELEPHONE_NUMBER_BUSINESS.controlName]: {
    maxlength: {

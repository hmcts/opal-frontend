...
export const FINES_MAC_PERSONAL_DETAILS_ALIAS: IAbstractFormArrayControlValidation[] = [
  {
    ...
    validators: [Validators.required, Validators.maxLength(20), SINGLE_ASCII_CHARACTERS_PATTERN_VALIDATOR],
  },
  {
    controlName: 'fm_personal_details_alias_surname',
    validators: [Validators.required, Validators.maxLength(30), SINGLE_ASCII_CHARACTERS_PATTERN_VALIDATOR],
  },
];

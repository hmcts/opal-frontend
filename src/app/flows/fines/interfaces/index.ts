...
import { IFinesDefendantAccountDetails } from './fines-defendant-account-details.interface';
import { IFinesDefendantAccountNote } from './fines-defendant-account-note.interface';

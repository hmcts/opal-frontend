...
export interface IFinesAccDebtorAddAmendForm {
  ...
  facc_debtor_add_amend_aliases: IFinesAccDebtorAddAmendAlias[];
...
export interface IFinesAccDebtorAddAmendAlias {
  facc_debtor_add_amend_alias_forenames: string | null;
  facc_debtor_add_amend_alias_surname: string | null;
}

export interface IFinesAccDebtorAddAmendFormData extends IAbstractFormBaseForm<IFinesAccDebtorAddAmendForm> {
  formData: IFinesAccDebtorAddAmendForm;
  nestedFlow: boolean;
}

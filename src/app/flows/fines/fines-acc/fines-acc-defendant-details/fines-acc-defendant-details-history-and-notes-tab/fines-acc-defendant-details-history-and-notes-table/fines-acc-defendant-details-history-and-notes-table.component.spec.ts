...
import { FINES_ACC_DEFENDANT_DETAILS_HISTORY_AND_NOTES_TABLE_MAP_TAB_DATA_MOCK } from './mocks/fines-acc-defendant-details-history-and-notes-table-map-tab-data.mock';
import { FINES_ACC_DEFENDANT_DETAILS_HISTORY_AND_NOTES_TABLE_RENDER_TAB_DATA_MOCK } from './mocks/fines-acc-defendant-details-history-and-notes-table-render-tab-data.mock';
import { FINES_ACC_DEFENDANT_DETAILS_HISTORY_AND_NOTES_TABLE_UNSUPPORTED_LINK_MOCK } from './mocks/fines-acc-defendant-details-history-and-notes-table-unsupported-link.mock';

describe('FinesAccDefendantDetailsHistoryAndNotesTableComponent', () => {
  let component: FinesAccDefendantDetailsHistoryAndNotesTableComponent;
  let fixture: ComponentFixture<FinesAccDefendantDetailsHistoryAndNotesTableComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [FinesAccDefendantDetailsHistoryAndNotesTableComponent],
      providers: [provideRouter([])],
    }).compileComponents();

    fixture = TestBed.createComponent(FinesAccDefendantDetailsHistoryAndNotesTableComponent);
  ...
  it('should render the shared history table with mapped rows', () => {
    fixture.componentRef.setInput(
      'tabData',
      structuredClone(FINES_ACC_DEFENDANT_DETAILS_HISTORY_AND_NOTES_TABLE_RENDER_TAB_DATA_MOCK),
    );
  ...
  it('should open account history links in a new browser tab', () => {
    ...
    const accountId = FINES_ACC_DEFENDANT_DETAILS_HISTORY_AND_NOTES_TABLE_ACCOUNT_LINK_MOCK.emit;

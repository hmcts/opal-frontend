...
import { FINES_ACC_MAJOR_CREDITOR_HISTORY_AND_NOTES_DETAILS_TRANSFORMERS } from './fines-acc-major-creditor-history-and-notes-details-transformers.constant';

export const FINES_ACC_MAJOR_CREDITOR_HISTORY_AND_NOTES_DETAILS_TRANSFORMATION_CONFIG: IHistoryTransformationConfig = {
  ...
  transformers: FINES_ACC_MAJOR_CREDITOR_HISTORY_AND_NOTES_DETAILS_TRANSFORMERS,
};

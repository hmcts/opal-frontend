  ...
  it('should build payload for pay in full payment type', () => {
    ...
    expect(result).toEqual({
      payment_terms: {
        ...
        extension: true,
        payment_terms_type: { payment_terms_type_code: 'B', payment_terms_type_display_name: null }, // Pay in full is 'B' with no lump sum amount
  ...
  it('should build payload for instalments only payment type', () => {
    ...
    expect(result).toEqual({
      payment_terms: {
        ...
        extension: true,
        payment_terms_type: { payment_terms_type_code: 'I', payment_terms_type_display_name: null },
  ...
  it('should build payload for lump sum plus instalments payment type', () => {
    ...
    expect(result).toEqual({
      payment_terms: {
        ...
        instalment_period: { instalment_period_code: 'W', instalment_period_display_name: null },

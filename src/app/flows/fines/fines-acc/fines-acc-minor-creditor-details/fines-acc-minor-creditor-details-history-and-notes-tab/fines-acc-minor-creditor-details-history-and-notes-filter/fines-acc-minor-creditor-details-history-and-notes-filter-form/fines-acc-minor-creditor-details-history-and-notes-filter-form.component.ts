...
import { FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_CATEGORIES } from '../../constants/fines-acc-minor-creditor-details-history-and-notes-filter-categories.constant';
import { FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_FIELD_ERRORS } from '../../constants/fines-acc-minor-creditor-details-history-and-notes-filter-field-errors.constant';
import { FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_SUMMARY_TEXT } from '../../constants/fines-acc-minor-creditor-details-history-and-notes-filter-summary-text.constant';
...
import { IFinesAccMinorCreditorDetailsHistoryAndNotesFilterFormControls } from '../../interfaces/fines-acc-minor-creditor-details-history-and-notes-filter-form-controls.interface';
...
@Component({
  selector: 'app-fines-acc-minor-creditor-details-history-and-notes-filter-form',
  imports: [
    ReactiveFormsModule,
  ...
  templateUrl: './fines-acc-minor-creditor-details-history-and-notes-filter-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FinesAccMinorCreditorDetailsHistoryAndNotesFilterFormComponent
  ...
  implements OnChanges, OnInit, AfterViewInit, OnDestroy
{
  ...
  @Output() protected override formSubmit = new EventEmitter<IFinesAccMinorCreditorDetailsHistoryAndNotesFilterForm>();
  protected override fieldErrors: IFinesAccMinorCreditorDetailsHistoryAndNotesFilterFieldErrors =
    FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_FIELD_ERRORS;
  ...
  public readonly categories = FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_CATEGORIES;
  public readonly filterDetailsSummaryText = signal<string>(
    FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_SUMMARY_TEXT.show,
  );
  ...
  private setupFilterForm(): void {
    this.form = new FormGroup<IFinesAccMinorCreditorDetailsHistoryAndNotesFilterFormControls>({
      ...
      categories: new FormRecord<FormControl<boolean>>(
        FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_CATEGORIES.reduce<Record<string, FormControl<boolean>>>(
          (controls, category) => {
  ...
  private updateFilterDetailsSummaryText(open: boolean): void {
    this.filterDetailsSummaryText.set(
      open
        ? FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_SUMMARY_TEXT.hide
        : FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_SUMMARY_TEXT.show,
    );
  }
  ...
  public getCategoryControl(
    categoryValue: TFinesAccMinorCreditorDetailsHistoryAndNotesFilterCategory,
  ): FormControl<boolean> {

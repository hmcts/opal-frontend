...
export class FinesAccMinorCreditorDetailsHistoryAndNotesFilterComponent extends AbstractFormParentBaseComponent {
  ...
  public readonly fieldErrors = FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_FIELD_ERRORS;
  public readonly summaryText = FINES_ACC_MINOR_CREDITOR_DETAILS_HISTORY_AND_NOTES_FILTER_SUMMARY_TEXT;
  ...
  public handleFilterSubmit(form: IFinesAccHistoryAndNotesFilterForm): void {
    this.filterApplied.emit(form as IFinesAccMinorCreditorDetailsHistoryAndNotesFilterForm);
  }

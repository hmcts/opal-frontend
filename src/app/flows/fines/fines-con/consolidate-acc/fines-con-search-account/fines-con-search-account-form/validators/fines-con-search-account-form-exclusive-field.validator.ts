 ...
 */
export const exclusiveSearchFieldValidator: ValidatorFn = ((control: AbstractControl): ValidationErrors | null => {
  const rules: ExclusiveFieldRuleConfig[] = [
    ...
    {
      primaryField: 'fcon_search_account_individuals_national_insurance_number',
      conflictingFields: [
        'fcon_search_account_individuals_last_name',
        'fcon_search_account_individuals_first_names',
        'fcon_search_account_individuals_date_of_birth',

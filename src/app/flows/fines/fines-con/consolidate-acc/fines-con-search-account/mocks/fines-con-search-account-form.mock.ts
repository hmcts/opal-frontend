 ...
 */
export const FINES_CON_SEARCH_ACCOUNT_FORM_MOCK: IFinesConSearchAccountForm = {
  formData: {
...
/**
 * Mock for FinesConSearchAccountForm with empty/default values
 */
export const FINES_CON_SEARCH_ACCOUNT_FORM_EMPTY_MOCK: IFinesConSearchAccountForm = {
  formData: {
    fcon_search_account_number: null,
    fcon_search_account_national_insurance_number: null,
    fcon_search_account_individuals_search_criteria: {

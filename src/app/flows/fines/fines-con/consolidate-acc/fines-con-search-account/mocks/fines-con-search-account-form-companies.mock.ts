...
/**
 * Mock for FinesConSearchAccountForm with populated company search criteria
 */
export const FINES_CON_SEARCH_ACCOUNT_FORM_COMPANIES_MOCK: IFinesConSearchAccountForm = {
  formData: {
    ...
    fcon_search_account_companies_search_criteria: {
      fcon_search_account_companies_company_name: 'Acme Corp',
      fcon_search_account_companies_company_name_exact_match: true,
      fcon_search_account_companies_include_aliases: false,
      fcon_search_account_companies_address_line_1: '123 Business Street',
      fcon_search_account_companies_post_code: 'SW1A 1AA',
    },
  },
  nestedFlow: false,
};

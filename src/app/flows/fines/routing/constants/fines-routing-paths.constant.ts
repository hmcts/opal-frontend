...
import { FINES_CONSOLIDATION_ROUTING_PATHS } from '../../fines-consolidation/routing/constants/fines-consolidation-routing-paths.constant';
...
export const FINES_ROUTING_PATHS: IFinesRoutingPaths = {
  ...
  children: {
    ...
    con: FINES_CONSOLIDATION_ROUTING_PATHS,
  },
};

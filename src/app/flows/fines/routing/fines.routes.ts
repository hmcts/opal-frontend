...
import { routing as consolidationRouting } from '../fines-consolidation/routing/fines-consolidation.routes';
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('../fines-consolidation/fines-consolidation.component').then((c) => c.FinesConsolidationComponent),

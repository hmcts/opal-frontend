 ...
 * the current applied query or filter state. "Your reports" is scoped to the current user; all other routes are
 * scoped to their configured report type.
 *

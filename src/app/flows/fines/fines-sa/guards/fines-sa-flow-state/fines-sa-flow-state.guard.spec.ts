...
describe('finesSaFlowStateGuard', () => {
  ...
  it('should return true if account number is present', async () => {
  ...
  it('should return true if reference number is present', async () => {
  ...
  it('should return true if search criteria is populated', async () => {
    mockFinesSaStore.setSearchAccount({
      ...FINES_SA_SEARCH_ACCOUNT_STATE,
  ...
  it('should return false if nothing is entered', async () => {

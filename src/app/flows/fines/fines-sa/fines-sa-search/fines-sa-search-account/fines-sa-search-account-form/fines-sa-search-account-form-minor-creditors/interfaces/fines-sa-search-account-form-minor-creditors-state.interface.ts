export interface IFinesSaSearchAccountFormMinorCreditorsState {
  ...
  fsa_search_account_minor_creditors_last_name_exact_match: boolean;
  fsa_search_account_minor_creditors_first_names: string | null;
  fsa_search_account_minor_creditors_first_names_exact_match: boolean;
  fsa_search_account_minor_creditors_company_name: string | null;
  fsa_search_account_minor_creditors_company_name_exact_match: boolean;

...
import { FINES_SA_SEARCH_ACCOUNT_FORM_COMPANY_CONTROLS } from './constants/fines-sa-search-account-form-company-controls.constant';
...
describe('FinesSaSearchAccountFormCompaniesComponent', () => {
  ...
  beforeEach(async () => {
    ...
    component.form = new FormGroup(FINES_SA_SEARCH_ACCOUNT_FORM_COMPANY_CONTROLS);

...
import { IFinesSaSearchAccountFormMajorCreditorsState } from '../fines-sa-search-account-form/fines-sa-search-account-form-major-creditors/interfaces/fines-sa-search-account-form-major-creditors-state.interface';
...
export interface IFinesSaSearchAccountState {
  ...
  fsa_search_account_major_creditors_search_criteria: IFinesSaSearchAccountFormMajorCreditorsState | null;

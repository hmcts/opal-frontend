...
describe('FinesSaResultsDefendantTableWrapperComponent', () => {
  ...
  it('should announce the new page and focus its first account cell after rendering', async () => {
    component.tableData = GENERATE_FINES_SA_DEFENDANT_TABLE_WRAPPER_TABLE_DATA_MOCKS(2);
    ...
    const firstCell = fixture.nativeElement.querySelector('td#defendantAccountNumber') as HTMLTableCellElement;
    const status = fixture.nativeElement.querySelector('output') as HTMLOutputElement;
    expect(firstCell.textContent).toContain('ACC2');

...
export const FEATURE_FLAG_RELEASE_PERMISSIONS: FeatureFlagReleasePermissions = {
  ...
  [RELEASE_1B_FEATURE_FLAG]: [FINES_PERMISSIONS['search-and-view-accounts']],
  [RELEASE_1C_WRITE_OFF_FEATURE_FLAG]: [FINES_PERMISSIONS['consolidate']],
  [RELEASE_1C_ENFORCEMENT_OPERATIONAL_REPORTING_FEATURE_FLAG]: REPORTS_PRIMARY_NAVIGATION_PERMISSIONS,
};

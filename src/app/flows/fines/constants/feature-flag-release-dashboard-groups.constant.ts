...
export const FEATURE_FLAG_RELEASE_DASHBOARD_GROUPS: FeatureFlagReleaseDashboardGroups = {
  ...
  // `administration-test` is a placeholder group id until the Administration dashboard content is developed.
  [RELEASE_1C_ADMINISTRATION_FEATURE_FLAG]: ['administration-test'],
};

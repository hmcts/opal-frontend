...
import { finesDraftCheckAndValidateTabResolver } from './fines-draft-check-and-validate-tab.resolver';
...
describe('finesDraftCheckAndValidateTabResolver', () => {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const executeResolver: ResolveFn<any> = (...resolverParameters) =>
    TestBed.runInInjectionContext(() => finesDraftCheckAndValidateTabResolver(...resolverParameters));

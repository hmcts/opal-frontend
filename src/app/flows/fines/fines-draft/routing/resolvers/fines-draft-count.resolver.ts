...
import { FinesDraftCountResolverOptions } from './interfaces/fines-draft-count-resolver-options.interface';
 ...
 */
export function finesDraftCountResolver(options: FinesDraftCountResolverOptions): ResolveFn<number> {
  return () => {

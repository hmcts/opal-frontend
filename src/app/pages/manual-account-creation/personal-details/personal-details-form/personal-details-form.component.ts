  ...
  private setupPersonalDetailsForm(): void {
    this.form = new FormGroup({
      ...
      aliases: new FormGroup({
        ...
        firstNames2: new FormControl(null),
        lastName2: new FormControl(null),
        firstNames3: new FormControl(null),
        lastName3: new FormControl(null),
        firstNames4: new FormControl(null),
        lastName4: new FormControl(null),
        firstNames5: new FormControl(null),
        lastName5: new FormControl(null),
      }),
